#include "lib_battery_dispatch_pvsmoothingts_fom.h"
#include "lib_battery_powerflow.h"
#include "lib_utility_rate.h"

#include <numeric>

dispatch_pvsmoothingts_front_of_meter_t::dispatch_pvsmoothingts_front_of_meter_t(
	battery_t * Battery,
	double dt_hour,
	double SOC_min,
	double SOC_max,
...
dispatch_pvsmoothingts_front_of_meter_t::~dispatch_pvsmoothingts_front_of_meter_t(){ /* NOTHING TO DO */}

void dispatch_pvsmoothingts_front_of_meter_t::init_with_pointer(const dispatch_pvsmoothingts_front_of_meter_t* tmp)
{
...
dispatch_pvsmoothingts_front_of_meter_t::dispatch_pvsmoothingts_front_of_meter_t(const dispatch_t & dispatch) :
dispatch_automatic_t(dispatch)
{
	const dispatch_pvsmoothingts_front_of_meter_t * tmp = dynamic_cast<const dispatch_pvsmoothingts_front_of_meter_t *>(&dispatch);
	init_with_pointer(tmp);
}

// shallow copy from dispatch to this
void dispatch_pvsmoothingts_front_of_meter_t::copy(const dispatch_t * dispatch)
{
...
void dispatch_pvsmoothingts_front_of_meter_t::dispatch(size_t year,
	size_t hour_of_year,
	size_t step)
{
    curr_year = year;
...
void dispatch_pvsmoothingts_front_of_meter_t::update_dispatch(size_t year, size_t hour_of_year, size_t , size_t lifetimeIndex)
{
	// Initialize
...
void dispatch_pvsmoothingts_front_of_meter_t::update_pv_data(double_vec P_pv_ac)
{
	_P_pv_ac = P_pv_ac;
...
void dispatch_pvsmoothingts_front_of_meter_t::costToCycle()
{

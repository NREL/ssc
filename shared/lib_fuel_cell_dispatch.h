...
public:
    ...
    void
    runSingleTimeStep(size_t hour_of_year, size_t year_idx, double powerSystem_kWac = 0, double powerLoad_kWac = 0);
    ...
    enum FC_DISPATCH_OPTION {
        FIXED, LOAD_FOLLOW, MANUAL, INPUT
    };

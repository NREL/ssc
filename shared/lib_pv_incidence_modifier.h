...
static const double l_arc =
        l_glass * 0.01; // thickness of anti-reflective coating- assume 1/100th of thickness of glass
...
double
calculateIrradianceThroughCoverDeSoto(double incidenceAngleDegrees, double zenithAngleDegrees, double tiltDegrees,

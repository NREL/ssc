...
public:
    ...
    enum FC_SHUTDOWN_OPTION {
        SHUTDOWN, IDLE
    };

    /// Fuel cell replacement options
    enum FC_REPLACEMENT_OPTION {
        NONE, REPLACE_AT_CAPACITY, REPLACE_ON_SCHEDULE
    };

protected:

    enum FC_EFFICIENCY_COLUMN {
        PERCENT_MAX, PRECENT_ELECTRICAL_EFFICIENCY, PERCENT_HEAT_RECOVERY
    };
    enum FC_SHUTDOWN_COLUMN {
        HOUR, DURATION
    };
    enum FC_EFFICIENCY_CHOICE {
        ORIGINAL_NAMEPLATE, DEGRADED_MAX
    };

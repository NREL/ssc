...
/*   VARTYPE           DATATYPE         NAME                         LABEL                              UNITS     META                      GROUP          REQUIRED_IF                 CONSTRAINTS                      UI_HINTS*/
	...
	{ SSC_OUTPUT,       SSC_ARRAY,       "t_cell",                      "Cell temperature",               "'C",     "",                      "PVWatts",      "*",                       "LENGTH_EQUAL=beam",                          "" },
...
class cm_pvwattsperf : public compute_module
{
private:
public:
	cm_pvwattsperf()
	...
	void exec( ) throw( general_error )
	{
		...
		ssc_number_t *p_tcell = allocate("t_cell", arr_len);
...
DEFINE_MODULE_ENTRY( pvwattsperf, "PVWatts system performance calculator.  Does not include weather file reading or irradiance processing.", 1 )

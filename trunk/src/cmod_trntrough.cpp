...
/*   VARTYPE           DATATYPE         NAME                                  LABEL                                UNITS      META                      GROUP          REQUIRED_IF                  CONSTRAINTS                      UI_HINTS*/
	...
	{ SSC_INPUT,        SSC_NUMBER,      "max_hel_trough_dist_ratio",          "Max helio-to-trough distance ratio", "frac", "",                        "CSPTower",      "*",                         "POSITIVE",                 "" },
	{ SSC_INPUT,        SSC_NUMBER,      "min_hel_trough_dist_ratio",          "Min helio-to-trough distance ratio", "frac", "",                        "CSPTower",      "*",                         "POSITIVE",                 "" },
	...
	{ SSC_INPUT,        SSC_NUMBER,      "trough_height",                      "Tower height",                      "m",      "",                      "CSPTower",      "*",                         "POSITIVE",                 "" },

...
ssc_set("itc_sta_amount", 20000)
'ssc_set("itc_sta_percent", array(10))
ssc_set("itc_sta_percent", 0)
...
ssc_set("itc_fed_amount", 10000)
'ssc_set("itc_fed_percent", array(30))
ssc_set("itc_fed_percent", 0)
...
ssc_set("ibi_sta_amount", 2000)
ssc_set("ibi_sta_percent", 10)
ssc_set("ibi_sta_amount_deprbas_sta", 1)
ssc_set("ibi_sta_amount_deprbas_fed", 1)
ssc_set("ibi_sta_percent_deprbas_fed", 0)
ssc_set("ibi_sta_percent_deprbas_sta", 0)

ssc_set("ibi_fed_amount", 1000)
ssc_set("ibi_fed_percent", 5)
ssc_set("ibi_fed_amount_deprbas_sta", 1)
ssc_set("ibi_fed_amount_deprbas_fed", 1)
ssc_set("ibi_fed_percent_deprbas_fed", 0)
ssc_set("ibi_fed_percent_deprbas_sta", 0)

ssc_set("ibi_uti_amount", 500)
ssc_set("ibi_uti_percent", 1)
...
ssc_set("ibi_oth_amount", 250)
ssc_set("ibi_oth_percent", 0.5)
...
ssc_set("cbi_fed_amount", 0.5)
ssc_set("cbi_sta_amount", 0.2)
ssc_set("cbi_uti_amount", 0.01)
ssc_set("cbi_oth_amount", 0.005)

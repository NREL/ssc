//File automatically generated by variable_map_makefile.py 2016/10/17
...
struct var_heliostat
{
	...
	struct CANT_METHOD{ enum EN{NO_CANTING=0,ONAXIS_AT_SLANT=-1,ONAXIS_USERDEFINED=1,OFFAXIS_DAY_AND_HOUR=3,_USERDEFINED_VECTOR=4}; };

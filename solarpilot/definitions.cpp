...
void var_map::reset()
{
	...
	opt.algorithm                    .set("optimize.0.algorithm"             , SP_DATTYPE::SP_STRING    ,                  "1",           "",     true,    "combo", "BOBYQA=0;COBYLA=1;NEWOUA=2;Nelder-Mead=3;Subplex=4;RSGS=5",    false,                 "Optimization algorithm", "Optimization algorithm");

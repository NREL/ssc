...
void var_map::reset()
{
	...
	amb.sun_type                     .set("ambient.0.sun_type"               , SP_DATTYPE::SP_STRING    ,                  "2",       "none",     true,    "combo", "Pillbox sun=2;Gaussian sun=4;Limb-darkened sun=1;sp_point sun=0;Buie CSR=5;User sun=3;",    false,                         "Sunshape model", "Sunshape model - {0=point sun, 1=limb darkened sun, 2=square wave sun, 3=user sun}");

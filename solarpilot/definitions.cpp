...
void var_map::reset()
{
	...
	amb.atm_model                    .set("ambient.0.atm_model"              , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "DELSOL3 clear day=0;DELSOL3 hazy day=1;User-defined=2",    false,          "Atmospheric attenuation model", "Atmospheric attenuation model {0=25km Barstow, 1 = 5km Barstow, 2 = user defined}");
	...
	amb.insol_type                   .set("ambient.0.insol_type"             , SP_DATTYPE::SP_INT       ,                  "0",       "none",    false,    "combo", "Weather file data=-1;Meinel model=0;Hottel model=1;Constant value=2;Allen model=3;Moon model=4",    false,                       "Insolation model", "Model used to determine insolation as a function of time");
	...
	amb.sun_type                     .set("ambient.0.sun_type"               , SP_DATTYPE::SP_INT       ,                  "2",       "none",     true,    "combo", "Pillbox sun=2;Gaussian sun=4;Limb-darkened sun=1;Point sun=0;Buie CSR=5;User sun=3;",    false,                         "Sunshape model", "Sunshape model - {0=point sun, 1=limb darkened sun, 2=square wave sun, 3=user sun}");
	...
	crec.basis_method                .set("custom_rec.0.basis_method"        , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "Average=0;Median=1;Peak=2;Tube design point=3;Specified=4",    false,            "Flux absorption basis value", "Metric to use as base flux value in determining profile quality");
	...
	crec.circ_profile                .set("custom_rec.0.circ_profile"        , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "Sinusoidal=0;Square=1",    false,           "Circumferential flux profile", "Method for generating circumferential flux profile based on available data points");
	...
	crec.design_location             .set("custom_rec.0.design_location"     , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "Peak flux=0;Circumferential delta=1",    false,         "Flux criteria for design point", "Flux criteria to determine the tube design point location");
	...
	crec.header_domain               .set("custom_rec.0.header_domain"       , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "Adjacent half panels=0;Adjacent full panels=1;Single unit surface=2",    false,                   "Header supply domain", "Method for dividing a flux panel into header sections");
	...
	crec.quality_method              .set("custom_rec.0.quality_method"      , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "All panels together=0;Split by panel=1;Split by header=2",    false,         "Flux quality evaluation domain", "Method for calculating the quality of the flux profile");
	...
	crec.tube_material               .set("custom_rec.0.tube_material"       , SP_DATTYPE::SP_INT       ,                  "0",           "",     true,    "combo", "Haynes 230=0;Stainless Steel 316=1",    false,                          "Tube material", "Tube material");
	...
	fin.heliostat_spec_cost          .set("financial.0.heliostat_spec_cost"  , SP_DATTYPE::SP_DOUBLE    ,                "180",       "$/m2",     true,         "",    "",    false,                        "Heliostat field", "Cost per square meter of heliostat aperture area of the heliostat field");
	...
	fin.plant_spec_cost              .set("financial.0.plant_spec_cost"      , SP_DATTYPE::SP_DOUBLE    ,               "1200",      "$/kWe",     true,         "",    "",    false,                 "Power block and plant ", "Cost of the power block and balance of plant equipment per kilowatt (electric) gross design power");
	...
	fin.rec_ref_cost                 .set("financial.0.rec_ref_cost"         , SP_DATTYPE::SP_DOUBLE    ,          "126200000",          "$",     true,         "",    "",    false,                "Receiver reference cost", "Cost of the receiver at the sizing indicated by the reference receiver area");
	...
	fin.site_spec_cost               .set("financial.0.site_spec_cost"       , SP_DATTYPE::SP_DOUBLE    ,                 "20",       "$/m2",     true,         "",    "",    false,                      "Site improvements", "Cost per square meter of heliostat aperture area of site improvements");
	fin.tes_spec_cost                .set("financial.0.tes_spec_cost"        , SP_DATTYPE::SP_DOUBLE    ,                 "27",     "$/kWht",     true,         "",    "",    false,                        "Thermal storage", "Cost of thermal storage per kilowatt hour (thermal) capacity");
	...
	fin.tower_fixed_cost             .set("financial.0.tower_fixed_cost"     , SP_DATTYPE::SP_DOUBLE    ,            "1927000",          "$",     true,         "",    "",    false,                       "Fixed tower cost", "Fixed tower cost - used as the basis for scaling tower cost as a function of height");
	...
	fin.wiring_user_spec             .set("financial.0.wiring_user_spec"     , SP_DATTYPE::SP_DOUBLE    ,                  "9",       "$/m2",     true,         "",    "",    false,                   "Wiring specific cost", "Cost of wiring per square meter of heliostat aperture area");
	...
	flux.aim_method                  .set("fluxsim.0.aim_method"             , SP_DATTYPE::SP_INT       ,                  "3",           "",     true,    "combo", "Simple aim points=0;Sigma aiming=1;Probability shift=2;Image size priority=3;Keep existing=4;Freeze tracking=5",    false,             "Heliostat aim point method", "Method for determining the aim point for each heliostat");
	...
	flux.cloud_shape                 .set("fluxsim.0.cloud_shape"            , SP_DATTYPE::SP_INT       ,                  "0",           "",     true,    "combo", "Elliptical=0;Rectangular=1;Front=2",    false,                            "Cloud shape", "Shape used to model the cloud shadow");
	...
	flux.flux_dist                   .set("fluxsim.0.flux_dist"              , SP_DATTYPE::SP_INT       ,                  "0",           "",     true,    "combo", "Triangular=0;Normal=1;Uniform=2",    false,        "Aim point distribution sampling", "Sampling basis for random positioning. Non-uniform distributions are weighted away from the center.");
	...
	flux.flux_model                  .set("fluxsim.0.flux_model"             , SP_DATTYPE::SP_INT       ,                  "0",       "none",    false,    "combo", "Hermite (analytical)=0;SolTrace=1",    false,                  "Flux simulation model", "Desired flux simulation tool. Not all geometries can be simulated using the Hermite approximation.");
	...
	flux.flux_time_type              .set("fluxsim.0.flux_time_type"         , SP_DATTYPE::SP_INT       ,                  "1",       "none",    false,    "combo", "Sun position=0;Hour/Day=1",    false,           "Simulation time spec. method", "Method for specifying the desired flux simulation time.");
	...
	land.is_land_max_opt             .set("land.0.is_land_max_opt"           , SP_DATTYPE::SP_BOOL      ,               "TRUE",           "",    false, "checkbox",    "",    false,           "Optimize outer land boundary", "Optimize outer land boundary");
	land.is_land_max_restrict        .set("land.0.is_land_max_restrict"      , SP_DATTYPE::SP_BOOL      ,              "FALSE",           "",    false, "checkbox",    "",     true,     "Restrict outer land boundary range", "Restrict outer land boundary range");
	...
	land.land_max_opt_max            .set("land.0.land_max_opt_max"          , SP_DATTYPE::SP_DOUBLE    ,                  "6",   "tower-ht",    false,         "",    "",     true,           "Maximum outer boundary value", "Maximum outer boundary value");
	land.land_max_opt_min            .set("land.0.land_max_opt_min"          , SP_DATTYPE::SP_DOUBLE    ,                 "23",   "tower-ht",    false,         "",    "",     true,           "Minimum outer boundary value", "Minimum outer boundary value");
	...
	land.max_fixed_rad               .set("land.0.max_fixed_rad"             , SP_DATTYPE::SP_DOUBLE    ,               "1500",          "m",     true,         "",    "",    false,            "Maximum land radius (fixed)", "Outer land boundary for circular land plot");
	land.max_scaled_rad              .set("land.0.max_scaled_rad"            , SP_DATTYPE::SP_DOUBLE    ,                "7.5",       "none",     true,         "",    "",    false,                   "Maximum field radius", "Maximum radius (in units of tower height) for positioning of the heliostats");
	...
	opt.algorithm                    .set("optimize.0.algorithm"             , SP_DATTYPE::SP_INT       ,                  "0",           "",     true,    "combo", "BOBYQA=0;COBYLA=1;NEWOUA=2;Nelder-Mead=3;Subplex=4;RSGS=5",    false,                 "Optimization algorithm", "Optimization algorithm");
	opt.class_name                   .set("optimize.0.class_name"            , SP_DATTYPE::SP_STRING    ,       "Optimization",           "",    false,         "",    "",    false,                                       "", "");
	opt.converge_tol                 .set("optimize.0.converge_tol"          , SP_DATTYPE::SP_DOUBLE    ,              "0.001",       "none",     true,         "",    "",    false,                  "Convergence tolerance", "Relative change in the objective function below which convergence is achieved");
	opt.flux_penalty                 .set("optimize.0.flux_penalty"          , SP_DATTYPE::SP_DOUBLE    ,               "0.35",       "none",     true,         "",    "",    false,                   "Flux overage penalty", "Relative weight in the objective function given to flux intensity over the allowable limit");
	...
	opt.max_step                     .set("optimize.0.max_step"              , SP_DATTYPE::SP_DOUBLE    ,               "0.02",       "none",     true,         "",    "",    false,                      "Initial step size", "Maximum total relative step size during optimization");
	opt.power_penalty                .set("optimize.0.power_penalty"         , SP_DATTYPE::SP_DOUBLE    ,                "0.5",       "none",     true,         "",    "",    false,                 "Power shortage penalty", "Relative weight in the objective function given to power to the receiver below the required minimum");
	...
	par.eff_file_name                .set("parametric.0.eff_file_name"       , SP_DATTYPE::SP_STRING    ,      "eff_array.dat",           "",    false,         "",    "",    false,                   "Efficiency file name", "Name of the output file containing the efficiency matrix");
	...
	par.fluxmap_format               .set("parametric.0.fluxmap_format"      , SP_DATTYPE::SP_INT       ,                  "0",           "",    false,    "combo", "SAM format=0;12x10 array=1;Specified dimensions=2",    false,                "Fluxmap data dimensions", "Dimensions of the fluxmap data (rows,cols)");
	...
	plt.eta_cycle                    .set("plant.0.eta_cycle"                , SP_DATTYPE::SP_DOUBLE    ,              "0.425",       "none",     true,         "",    "",    false,      "Rated cycle conversion efficiency", "Thermodynamic efficiency of the power cycle, including feedwater pumps and cooling equipment parasitics");
	plt.hours_tes                    .set("plant.0.hours_tes"                , SP_DATTYPE::SP_DOUBLE    ,                  "6",         "hr",     true,         "",    "",    false,     "Hours of full-load thermal storage", "Capacity of Hours of thermal storage operation at full cycle output");
	...
	plt.power_net_max                .set("plant.0.power_net_max"            , SP_DATTYPE::SP_DOUBLE    ,                "100",        "MWe",    false,         "",    "",     true,     "Maximum net power for optimization", "Maximum net electric power rating considered for optimization - calculated from Layout page");
	plt.power_net_min                .set("plant.0.power_net_min"            , SP_DATTYPE::SP_DOUBLE    ,                "100",        "MWe",    false,         "",    "",     true,     "Minimum net power for optimization", "Minimum net electric power rating considered for optimization - calculated from Layout page");
	plt.solar_mult                   .set("plant.0.solar_mult"               , SP_DATTYPE::SP_DOUBLE    ,                "1.9",       "none",     true,         "",    "",    false,                         "Solar multiple", "Ratio of thermal power output from the solar field to power cycle thermal input at design");
	...
	sf.des_sim_detail                .set("solarfield.0.des_sim_detail"      , SP_DATTYPE::SP_INT       ,                  "5",       "none",     true,    "combo", "Subset of days/hours=2;Single simulation point=1;Do not filter heliostats=0;Annual simulation=3;Limited annual simulation=4;Representative profiles=5;Efficiency map + annual=6",    false,               "Optimization simulations", "Simulation detail for placing heliostats (see definitions in options spreadsheet)");
	...
	sf.is_power_opt                  .set("solarfield.0.is_power_opt"        , SP_DATTYPE::SP_BOOL      ,              "FALSE",       "none",    false, "checkbox",    "",     true,                  "Optimize power output", "Vary the power output during optimization to identify optimal level?");
	sf.is_power_restrict             .set("solarfield.0.is_power_restrict"   , SP_DATTYPE::SP_BOOL      ,              "FALSE",       "none",    false, "checkbox",    "",     true,           "Restrict power output search", "Restrict the search range for power output to the indicated limits");
	...
	sf.is_tht_restrict               .set("solarfield.0.is_tht_restrict"     , SP_DATTYPE::SP_BOOL      ,              "FALSE",       "none",    false, "checkbox",    "",     true,           "Restrict tower height search", "Restrict the search range for tower height to the indicated limits");
	...
	sf.layout_method                 .set("solarfield.0.layout_method"       , SP_DATTYPE::SP_INT       ,                  "0",       "none",    false,    "combo", "Radial Stagger=1;Cornfield=2;User-defined=3",    false,                          "Layout method", "Field layout method");
	...
	sf.q_des                         .set("solarfield.0.q_des"               , SP_DATTYPE::SP_DOUBLE    ,                "500",        "MWt",     true,         "",    "",    false,               "Solar field design power", "Design thermal power delivered from the solar field");
	sf.q_des_opt_max                 .set("solarfield.0.q_des_opt_max"       , SP_DATTYPE::SP_DOUBLE    ,               "1000",        "MWt",    false,         "",    "",     true,       "Maximum solar field design power", "Maximum possible solar field design power during optimzation");
	sf.q_des_opt_min                 .set("solarfield.0.q_des_opt_min"       , SP_DATTYPE::SP_DOUBLE    ,                "100",        "MWt",    false,         "",    "",     true,       "Minimum solar field design power", "Minimum possible solar field design power during optimzation");
	sf.rad_spacing_method            .set("solarfield.0.rad_spacing_method"  , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "No blocking-dense=3;Eliminate blocking=2;DELSOL Empirical Fit=1",    false,                  "Radial spacing method", "Method for determining radial spacing during field layout for radial-stagger");
	...
	sf.shadow_height                 .set("solarfield.0.shadow_height"       , SP_DATTYPE::SP_DOUBLE    ,                "180",          "m",    false,         "",    "",    false,                    "Tower shadow height", "Effective tower height for shadowing calculations");
	...
	sf.sun_loc_des                   .set("solarfield.0.sun_loc_des"         , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "Summer solstice=0;Equinox=1;Winter solstice=2;Zenith=3;Other..=4",    false,           "Sun location at design point", "Sun location when thermal power rating is achieved");
	sf.temp_which                    .set("solarfield.0.temp_which"          , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo",    "",    false,              "Select heliostat geometry", "Select the heliostat geometry template that will be used in the layout");
	sf.template_rule                 .set("solarfield.0.template_rule"       , SP_DATTYPE::SP_INT       ,                  "0",           "",     true,    "combo", "Use single template=0;Specified range=1;Even radial distribution=2",    false,        "Heliostat geometry distribution", "Method for distributing heliostat geometry templates in the field");
	sf.tht                           .set("solarfield.0.tht"                 , SP_DATTYPE::SP_DOUBLE    ,                "180",          "m",     true,         "",    "",    false,                   "Tower optical height", "Average height of the tower receiver centerline above the base heliostat pivot point elevation");
	sf.tht_opt_max                   .set("solarfield.0.tht_opt_max"         , SP_DATTYPE::SP_DOUBLE    ,                "225",          "m",     true,         "",    "",     true,                   "Maximum tower height", "Maximum allowable tower height during optimization");
	sf.tht_opt_min                   .set("solarfield.0.tht_opt_min"         , SP_DATTYPE::SP_DOUBLE    ,                "125",          "m",     true,         "",    "",     true,                   "Minimum tower height", "Minimum allowable tower height during optimization");
	...
	sf.xy_field_shape                .set("solarfield.0.xy_field_shape"      , SP_DATTYPE::SP_INT       ,                  "0",           "",     true,    "combo", "Hexagon=0;Rectangle=1;Undefined=2",    false,           "Heliostat field layout shape", "Enforced shape of the heliostat field");
...
void var_map::add_heliostat(int id)
{
	...
	hels.back().cant_method          .set("heliostat."+sid+".cant_method"    , SP_DATTYPE::SP_INT       ,                  "1",       "none",     true,    "combo", "No canting=0;On-axis at slant=-1;On-axis, user-defined=1;Off-axis, day and hour=3; User-defined vector=4",    false,               "Heliostat canting method", "Integer to specify the canting method {0=none, -1=Cant on-axis equal to slant range, 1=user-defined on-axis, 3=user-defined off-axis at hour + day}");
	...
	hels.back().focus_method         .set("heliostat."+sid+".focus_method"   , SP_DATTYPE::SP_INT       ,                  "1",       "none",     true,    "combo", "Flat=0;At slant=1;Group average=2;User-defined=3",    false,                "Heliostat focusing type", "The focusing method {0=Flat, 1=Each at slant, 2=Average of group, 3=User defined}");
	...
	hels.back().is_round             .set("heliostat."+sid+".is_round"       , SP_DATTYPE::SP_BOOL      ,                  "0",       "none",    false,    "combo", "Rectangular=0;Round=1",    false,                        "Heliostat shape", "Is the heliostat round (true) or rectangular (false)");
	...
	hels.back().temp_rad_max         .set("heliostat."+sid+".temp_rad_max"   , SP_DATTYPE::SP_DOUBLE    ,                "7.5",       "none",    false,         "",    "",    false,      "Maximum radius for heliostat type", "Maximum radius at which this heliostat geometry can be used");
	...
	hels.back().track_method         .set("heliostat."+sid+".track_method"   , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "Continuous=0;Periodic=1",     true,       "Heliostat tracking update method", "Specify how often heliostats update their tracking position ");
...
void var_map::add_receiver(int id)
{
	...
	recs.back().accept_ang_type      .set("receiver."+sid+".accept_ang_type" , SP_DATTYPE::SP_INT       ,                  "0",       "none",     true,    "combo", "Rectangular=0;Elliptical=1",    false,       "Receiver acceptance angles shape", "Receiver angular acceptance window defines angles about the aperture normal, can be rectangular or elliptical shape");
	...
	recs.back().aperture_type        .set("receiver."+sid+".aperture_type"   , SP_DATTYPE::SP_INT       ,                  "0",           "",     true,    "combo", "Rectangular=0",    false,                "Aperture geometry shape", "The shape of the receiver aperture");
	recs.back().aspect_opt_max       .set("receiver."+sid+".aspect_opt_max"  , SP_DATTYPE::SP_DOUBLE    ,                  "2",          "m",    false,         "",    "",     true,          "Maximum receiver aspect ratio", "Maximum receiver aspect ratio during optimization");
	recs.back().aspect_opt_min       .set("receiver."+sid+".aspect_opt_min"  , SP_DATTYPE::SP_DOUBLE    ,                "0.5",          "m",    false,         "",    "",     true,          "Minimum receiver aspect ratio", "Minimum receiver aspect ratio during optimization");
	...
	recs.back().height_opt_max       .set("receiver."+sid+".height_opt_max"  , SP_DATTYPE::SP_DOUBLE    ,                 "30",          "m",    false,         "",    "",     true,                "Maximum receiver height", "Maximum receiver height during optimization");
	recs.back().height_opt_min       .set("receiver."+sid+".height_opt_min"  , SP_DATTYPE::SP_DOUBLE    ,                  "5",          "m",    false,         "",    "",     true,                "Minimum receiver height", "Minimum receiver height during optimization");
	...
	recs.back().is_aspect_restrict   .set("receiver."+sid+".is_aspect_restrict", SP_DATTYPE::SP_BOOL      ,              "FALSE",           "",    false, "checkbox",    "",     true,            "Restrict aspect ratio range", "Restrict aspect ratio range (height / width)");
	...
	recs.back().is_height_opt        .set("receiver."+sid+".is_height_opt"   , SP_DATTYPE::SP_BOOL      ,               "TRUE",           "",    false, "checkbox",    "",    false,               "Optimize receiver height", "Optimize receiver height");
	recs.back().is_height_restrict   .set("receiver."+sid+".is_height_restrict", SP_DATTYPE::SP_BOOL      ,              "FALSE",           "",    false, "checkbox",    "",     true,         "Restrict receiver height range", "Restrict receiver height range");
	...
	recs.back().peak_flux            .set("receiver."+sid+".peak_flux"       , SP_DATTYPE::SP_DOUBLE    ,                "800",      "kW/m2",     true,         "",    "",    false,                    "Allowable peak flux", "Maximum allowable flux intensity on any portion of the receiver surface");
	...
	recs.back().rec_diameter         .set("receiver."+sid+".rec_diameter"    , SP_DATTYPE::SP_DOUBLE    ,               "15.5",          "m",     true,         "",    "",    false,                      "Receiver diameter", "Receiver diameter for cylindrical receivers");
	...
	recs.back().rec_height           .set("receiver."+sid+".rec_height"      , SP_DATTYPE::SP_DOUBLE    ,                 "22",          "m",     true,         "",    "",    false,                        "Receiver height", "Height of the absorbing component");
	...
	recs.back().rec_type             .set("receiver."+sid+".rec_type"        , SP_DATTYPE::SP_INT       ,                  "0",       "none",    false,    "combo", "External cylindrical=0;Flat plate=2",    false,                          "Receiver type", "Receiver geometrical configuration");
	recs.back().rec_width            .set("receiver."+sid+".rec_width"       , SP_DATTYPE::SP_DOUBLE    ,               "15.5",          "m",     true,         "",    "",    false,                         "Receiver width", "Receiver width for cavity or flat receivers");
...
void var_land::addptrs(unordered_map<std::string, spbase*> &pmap)
{
	...
	pmap["land.0.is_land_max_opt"] = &is_land_max_opt;
	pmap["land.0.is_land_max_restrict"] = &is_land_max_restrict;
	pmap["land.0.land_const"] = &land_const;
	pmap["land.0.land_max_opt_max"] = &land_max_opt_max;
	pmap["land.0.land_max_opt_min"] = &land_max_opt_min;
...
void var_plant::addptrs(unordered_map<std::string, spbase*> &pmap)
{
	...
	pmap["plant.0.power_net_max"] = &power_net_max;
	pmap["plant.0.power_net_min"] = &power_net_min;
...
void var_receiver::addptrs(unordered_map<std::string, spbase*> &pmap)
{
	...
	pmap["receiver."+sid+".aspect_opt_max"] = &aspect_opt_max;
	pmap["receiver."+sid+".aspect_opt_min"] = &aspect_opt_min;
	pmap["receiver."+sid+".cbdata"] = &cbdata;
	pmap["receiver."+sid+".class_name"] = &class_name;
	pmap["receiver."+sid+".height_opt_max"] = &height_opt_max;
	pmap["receiver."+sid+".height_opt_min"] = &height_opt_min;
	pmap["receiver."+sid+".id"] = &id;
	pmap["receiver."+sid+".is_aspect_opt"] = &is_aspect_opt;
	pmap["receiver."+sid+".is_aspect_restrict"] = &is_aspect_restrict;
	pmap["receiver."+sid+".is_enabled"] = &is_enabled;
	pmap["receiver."+sid+".is_height_opt"] = &is_height_opt;
	pmap["receiver."+sid+".is_height_restrict"] = &is_height_restrict;
...
void var_solarfield::addptrs(unordered_map<std::string, spbase*> &pmap)
{
	...
	pmap["solarfield.0.is_power_opt"] = &is_power_opt;
	pmap["solarfield.0.is_power_restrict"] = &is_power_restrict;
	pmap["solarfield.0.is_prox_filter"] = &is_prox_filter;
	pmap["solarfield.0.is_tht_opt"] = &is_tht_opt;
	pmap["solarfield.0.is_tht_restrict"] = &is_tht_restrict;
	...
	pmap["solarfield.0.q_des_opt_max"] = &q_des_opt_max;
	pmap["solarfield.0.q_des_opt_min"] = &q_des_opt_min;
	...
	pmap["solarfield.0.tht_opt_max"] = &tht_opt_max;
	pmap["solarfield.0.tht_opt_min"] = &tht_opt_min;

...
void var_map::reset()
{
	...
	par.sam_grid_format              .set("parametric.0.sam_grid_format"     , SP_DATTYPE::SP_INT       ,                  "0",       "none",    false,    "combo", "Auto spacing=0;Even grid=1",    false,                   "SAM data grid format", "SAM data grid format");

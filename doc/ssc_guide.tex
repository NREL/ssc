...
const char *result = ssc_module_exec_simple_nothread( "pvwattsv1", data );
if( result == NULL )
	printf("success!\n");
else
...
The last (most complex) way to run a module is to provide a special handler that can reroute errors and warning messages, as well as provide progress updates to the controlling software.

' energy values used to match with DHF Team SAM Model Update - V4.1.xlsm
...
ssc_set("energy_availability", array(100.0))
ssc_set("energy_degradation", array(0.5))
ssc_set("federal_tax_rate", 35.0)
ssc_set("state_tax_rate", 5.5)
ssc_set("cost_salestax",2097150)
ssc_set("cost_prefinancing",40227150)

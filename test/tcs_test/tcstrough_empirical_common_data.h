...
void tcstrough_empirical_default(ssc_data_t &data) {
    ...
    int n1 = sprintf(solar_resource_path,
                     "%s/test/input_cases/trough_empirical_data/tucson_az_32.116521_-110.933042_psmv3_60_tmy.csv",
                     std::getenv("SSCDIR"));
    ...
    ssc_number_t p_TSLogic[36] = {1, 0.10000000000000001, 0.10000000000000001, 1.05, 2, 0.10000000000000001,
                                  0.10000000000000001, 1, 3, 0.10000000000000001, 0.10000000000000001, 1, 4,
                                  0.10000000000000001, 0.10000000000000001, 1, 5, 0.10000000000000001,
                                  0.10000000000000001, 1, 6, 0.10000000000000001, 0.10000000000000001, 1, 7,
                                  0.10000000000000001, 0.10000000000000001, 1, 8, 0.10000000000000001,
                                  0.10000000000000001, 1, 9, 0.10000000000000001, 0.10000000000000001, 1};

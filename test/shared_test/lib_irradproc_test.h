...
protected:
	...
	void SetUp() {
		...
		// Setup irradiance, calculate front side
		irr = new irrad();
...
// Calculated factors for specified case using Chris Deline bifacialvf: github.com/NREL/bifacialvf
...
static double expectedFrontAverageIrradiance = 2.83185423559;

...
protected:
    ...
    void SetUp() {
        ...
        irr_hourly_night.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
        ...
        irr_15m_night.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
    }
};
...
protected:
    ...
    void SetUp() {
        ...
        irr_hourly_sunrise.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
        ...
        irr_15m_sunrise.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
    }
};
...
protected:
    ...
    void SetUp() {
        ...
        irr_hourly_day.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
        ...
        irr_15m_day.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
    }
};
...
protected:
    ...
    virtual void SetUp() {
        ...
        irr_hourly_sunset.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
        ...
        irr_15m_sunset.set_surface(tracking, tilt, azim, rotlim, backtrack_on, gcr, false, 0.0, 0.0);
    }
};
/**
...
protected:
    ...
    void runIrradCalc(size_t index)
    {
        ...
        irr->set_surface(tracking, tilt, azim, rotlim, backtrack, gcr, false, 0.0, 0.0);

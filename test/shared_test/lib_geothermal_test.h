...
public:
    void SetUp() {
        ...
        switch (conversion_subtype) {
            case 0:
                geoPlant_inputs.me_ft = SINGLE_FLASH_NO_TEMP_CONSTRAINT;
                break;
            case 1:
                geoPlant_inputs.me_ft = SINGLE_FLASH_WITH_TEMP_CONSTRAINT;
                break;
            case 2:
                geoPlant_inputs.me_ft = DUAL_FLASH_NO_TEMP_CONSTRAINT;
                break;
            case 3:
                geoPlant_inputs.me_ft = DUAL_FLASH_WITH_TEMP_CONSTRAINT;
                break;
        }
        ...
        switch (reservoir_pressure_change_type) {
            case 0:
                geoPlant_inputs.me_pc = ENTER_PC;
                break;                // pressure change entered by user
            case 1:
                geoPlant_inputs.me_pc = SIMPLE_FRACTURE;
                break;        // use fracture flow (EGS only)
            case 2:
                geoPlant_inputs.me_pc = K_AREA;
                break;                // permeability * area
        }
        ...
        geoPlant_inputs.mi_TotalMakeupCalculations =
                geoPlant_inputs.mi_ProjectLifeYears * geoPlant_inputs.mi_MakeupCalculationsPerYear;

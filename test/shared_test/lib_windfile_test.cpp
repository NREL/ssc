...
TEST_F(windDataProviderCalculatorTest, FindClosestUsingData_lib_windfile_test) {
    ...
    windDataProvider->read(85, &spd, &dir, &temp, &pres, &heightOfClosestMeasuredSpd, &heightOfClosestMeasuredDir,
                           true);
    ...
    windDataProvider->read(95, &spd, &dir, &temp, &pres, &heightOfClosestMeasuredSpd, &heightOfClosestMeasuredDir,
                           true);

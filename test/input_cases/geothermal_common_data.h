...
static int n1 = sprintf(geothermal_weather_path,
                        "%s/test/input_cases/general_data/daggett_ca_34.865371_-116.783023_psmv3_60_tmy.csv", SSCDIR);
static int n2 = sprintf(geothermal_dispatch_path, "%s/test/input_cases/geothermal_data/dispatch_factors_ts.csv",
                        SSCDIR);
static int n3 = sprintf(geothermal_curtailment_path, "%s/test/input_cases/general_data/grid_curtailment_default_MW.csv",
                        SSCDIR);
...
static void geothermal_singleowner_default(ssc_data_t &data) {
    ...
    ssc_data_set_string(data, "hybrid_dispatch_schedule",

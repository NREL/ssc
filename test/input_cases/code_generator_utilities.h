...
*/
static int
modify_ssc_data_and_run_module(ssc_data_t &data, std::string module_name, std::map<std::string, double> pairs) {
...
static int
modify_ssc_data_and_run_module(ssc_data_t &data, std::string module_name, std::map<std::string, std::string> pairs) {

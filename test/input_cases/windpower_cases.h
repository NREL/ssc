...
int windpower_nofinancial_testfile(ssc_data_t &data)
{
	...
	ssc_data_set_number(data, "wind_resource_shear", 0.140);
	ssc_data_set_number(data, "wind_resource_turbulence_coeff", 0.100);
	...
	ssc_data_set_number(data, "wind_turbine_max_cp", 0.450);

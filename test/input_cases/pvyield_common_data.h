...
void pvyield_user_support_80603(ssc_data_t &data)
{
	ssc_data_set_string(data, "solar_resource_file", pvy_solar_resource_path);
//	ssc_data_set_string(data, "solar_resource_file", pvy_solar_resource_path2);
	...
	ssc_number_t inc_angle[10] = { 0.0, 30.0, 40.0, 50.0, 60.0, 70.0, 75.0, 80.0, 85.0, 90.0 };
	ssc_data_set_array(data, "mlm_IAM_c_cs_incAngle", inc_angle, 10);
	ssc_number_t inc_angle_value[10] = { 1.0, 0.999, 0.995, 0.987, 0.962, 0.892, 0.816, 0.681, 0.44, 0.0 };
	ssc_data_set_array(data, "mlm_IAM_c_cs_iamValue", inc_angle_value, 10);

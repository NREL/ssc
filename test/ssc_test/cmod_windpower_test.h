...
void CMWindPowerIntegration::assign_default_variables(var_table* vt){
	...
	for (unsigned int i = 0; i < 161; i++){
		...
		powercurve_powerout[i] = (float)powercurve_powerout_val[i];
		if (i < 32) {

...
TEST_F(CMTroughPhysicalIPH, DefaultNoFinancialModel_cmod_trough_physical_iph){
	...
	if (!test_errors)
	{
        ...
        EXPECT_NEAR(annual_thermal_consumption, 301.187063, 301.187063 * m_error_tolerance_hi) << "Annual Thermal Consumption";
        ...
        EXPECT_NEAR(annual_tes_freeze_protection, 301.187063, 301.187063 * m_error_tolerance_hi) << "Annual TES Freeze Protection";

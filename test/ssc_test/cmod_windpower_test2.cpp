...
testDeclaration defaultTest(windPowerTesting, "default", &windpowerDefaultInfo[0], 19, &windpowerDefaultResult[0], 3);
...
testDeclaration hubHeightErrorTest(windPowerTesting, "hubHeightError", &hubHeightErrorInfo[0], 2, &hubHeightErrorResult[0], 1);


/*
* Test 4
* Case where measurement heights are different from the turbine's hub height
* HubHeight is 90, use shear exponent interpolation
*/
...
testDeclaration hubHeightInterpolateTest(windPowerTesting, "hubHeightInterpolate", &hubHeightInterpolateInfo[0], 2, &hubHeightInterpolateResult[0], 1);

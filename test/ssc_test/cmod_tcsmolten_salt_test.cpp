...
NAMESPACE_TEST(csp_tower, SharedWithUi, SystemDesign) {
...
NAMESPACE_TEST(csp_tower, SharedWithUi, SolarPilotField) {
	double error_tolerance = 0.01;
	var_table* vd = new var_table;
...
NAMESPACE_TEST(csp_tower, SharedWithUi, SolarPilotFieldWithPeriodUse) {
...
NAMESPACE_TEST(csp_tower, SharedWithUi, Receiver) {
	double error_tolerance = 0.01;
	var_table* vd = new var_table;
...
NAMESPACE_TEST(csp_tower, SharedWithUi, ReceiverWithPeriodUse) {
    double error_tolerance = 0.01;
    var_table* vd = new var_table;
    vd->assign("t_htf_cold_des", 290.);
    vd->assign("t_htf_hot_des", 574.);
...
NAMESPACE_TEST(csp_tower, SharedWithUi, Tes) {
	double error_tolerance = 0.01;
...
NAMESPACE_TEST(csp_tower, SharedWithUi, TesWithPeriodUse) {
    double error_tolerance = 0.01;
    ssc_data_t data = ssc_data_create();
    auto data_vtab = static_cast<var_table*>(data);
...
NAMESPACE_TEST(csp_tower, SharedWithUi, SystemControl) {
	double error_tolerance = 0.01;
	var_table* vd = new var_table;
	vd->assign("bop_par", 0.);
...
NAMESPACE_TEST(csp_tower, SharedWithUi, SystemControlWithPeriods) {
    double error_tolerance = 0.01;
    var_table* vd = new var_table;
    vd->assign("bop_par", 0.);
    vd->assign("bop_par_f", 1.);
...
NAMESPACE_TEST(csp_tower, SharedWithUi, CapitalCosts) {
	double error_tolerance = 0.01;
	var_table* vd = new var_table;
	vd->assign("d_rec", 17.65);
...
NAMESPACE_TEST(csp_tower, SharedWithUi, CapitalCostsWithPeriods) {
    double error_tolerance = 0.01;
    var_table* vd = new var_table;
    vd->assign("d_rec", 17.65);
    vd->assign("rec_height", 21.60);
...
NAMESPACE_TEST(csp_tower, SharedWithUi, CopyingVarTable) {

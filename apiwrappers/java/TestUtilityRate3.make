...
run: all
	$(JAVA) $(LIBPATH) -jar TestUtilityRate3.jar
...
jar: java_classes dll
	$(JAR) cvfm TestUtilityRate3.jar TestUtilityRate3.Manifest.txt TestUtilityRate3.class SSC/*.class		

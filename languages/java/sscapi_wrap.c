 ...
 * Version 2.0.9
 * This file is modified to handle get_array, get_matrix, set_array and set_matrix
...
SWIGEXPORT jint JNICALL Java_sscapiJNI_ssc_1data_1get_1number(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jlong jarg3) {
  jint jresult = 0 ;
  ssc_data_t arg1 = (ssc_data_t) 0 ;
  char *arg2 = (char *) 0 ;
  ssc_number_t *arg3 = (ssc_number_t *) 0 ;
  ssc_bool_t result;
  ...
  arg3 = *(ssc_number_t **)&jarg3; 
  result = (ssc_bool_t)ssc_data_get_number(arg1,(char const *)arg2,arg3);
  jresult = (jint)result; 
  if (arg2) (*jenv)->ReleaseStringUTFChars(jenv, jarg2, (const char *)arg2);
  return jresult;
}
...
SWIGEXPORT jfloatArray JNICALL Java_sscapiJNI_ssc_1data_1get_1array(JNIEnv *env, jclass jcls, jlong cxt, jstring name, jintArray len) {
    int i, count;
    jfloatArray output;
    jint j_data_len;
    jfloat *j_data_array;

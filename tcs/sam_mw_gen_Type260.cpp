...
tcsvarinfo sam_mw_gen_type260_variables[] = {
	...
	{ TCS_INPUT,          TCS_NUMBER,             I_ITOTH,                  "itoth",                                                            "Total horizontal irradiation",    "kJ/hr-m^2",             "",             "",             "" },
...
public:
	...
	virtual int call(double time, double step, int ncall){
		...
		*/
		...
		//******************************************************************************************************************************
		ibn = value(I_IBN);		//Beam-normal (DNI) irradiation [kJ/hr-m^2]
		ibh = value(I_IBH);		//Beam-horizontal irradiation [kJ/hr-m^2]
		itoth = value(I_ITOTH);		//Total horizontal irradiation [kJ/hr-m^2]

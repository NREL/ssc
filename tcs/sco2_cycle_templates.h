...
public:
    ...
    struct S_auto_opt_design_hit_eta_parameters {
        ...
        bool
        (*mf_callback_log)(std::string &log_msg, std::string &progress_msg, void *data, double progress, int out_type);
...
public:
    ...
    virtual int
    auto_opt_design_hit_eta(S_auto_opt_design_hit_eta_parameters &auto_opt_des_hit_eta_in, std::string &error_msg) = 0;

...
void C_csp_solver::C_csp_solver_kernel::init(C_csp_solver::S_sim_setup &sim_setup, double wf_step /*s*/,
    ...
    if (baseline_step > wf_step) {
        std::string msg = util::format("The input Baseline Simulation Timestep (%lg [s]) must be less than or equal to "
                                       "the Weatherfile Timestep (%lg [s]). It was reset to the Weatherfile Timestep",
        ...
        std::string msg = util::format("The Weatherfile Timestep (%lg [s]) must be divisible by the "
                                       "input Baseline Simulation Timestep (%lg [s]). It was reset to %lg [s].",
...
static C_csp_reported_outputs::S_output_info S_solver_output_info[] =
        {
                ...
                {C_csp_solver::C_solver_outputs::N_OP_MODES,
                 C_csp_reported_outputs::TS_1ST},    //[-] Number of subtimesteps in reporting timestep
                ...
                {C_csp_solver::C_solver_outputs::CTRL_IS_REC_SU,
                 C_csp_reported_outputs::TS_1ST},              //[-] Control decision: is receiver startup allowed?
                {C_csp_solver::C_solver_outputs::CTRL_IS_PC_SU,
                 C_csp_reported_outputs::TS_1ST},                  //[-] Control decision: is power cycle startup allowed?
                {C_csp_solver::C_solver_outputs::CTRL_IS_PC_SB,
                 C_csp_reported_outputs::TS_1ST},                  //[-] Control decision: is power cycle standby allowed?
                {C_csp_solver::C_solver_outputs::EST_Q_DOT_CR_SU,
                 C_csp_reported_outputs::TS_1ST},              //[MWt] Estimate receiver startup thermal power
                {C_csp_solver::C_solver_outputs::EST_Q_DOT_CR_ON,
                 C_csp_reported_outputs::TS_1ST},              //[MWt] Estimate receiver thermal power to HTF
                ...
                {C_csp_solver::C_solver_outputs::DISPATCH_SOLVE_STATE,
                 C_csp_reported_outputs::TS_1ST},          //[-] The status of the dispatch optimization solver
                {C_csp_solver::C_solver_outputs::DISPATCH_SOLVE_ITER,
                 C_csp_reported_outputs::TS_1ST},          //[-] Number of iterations before completing dispatch optimization
                {C_csp_solver::C_solver_outputs::DISPATCH_SOLVE_OBJ,
                 C_csp_reported_outputs::TS_1ST},          //[?] Objective function value achieved by the dispatch optimization solver
                {C_csp_solver::C_solver_outputs::DISPATCH_SOLVE_OBJ_RELAX,
                 C_csp_reported_outputs::TS_1ST},      //[?] Objective function value for the relaxed continuous problem
                {C_csp_solver::C_solver_outputs::DISPATCH_QSF_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[MWt] Expected total solar field energy generation in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_QSFPROD_EXPECT,
                 C_csp_reported_outputs::TS_1ST},      //[MWt] Expected useful solar field energy generation in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_QSFSU_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[MWt] Solar field startup energy in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_TES_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[MWht] Thermal energy storage charge state in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_PCEFF_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[-] Expected power cycle efficiency adjustment in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_SFEFF_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[-] Expected solar field thermal efficiency adjustment in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_QPBSU_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[MWt] Power cycle startup energy consumption in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_WPB_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[MWe] Power cycle electricity production in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_REV_EXPECT,
                 C_csp_reported_outputs::TS_1ST},          //[MWe*fact] Power cycle electricity production times revenue factor in dispatch model
                {C_csp_solver::C_solver_outputs::DISPATCH_PRES_NCONSTR,
                 C_csp_reported_outputs::TS_1ST},          //[-] Number of constraint relationships in dispatch model formulation
                {C_csp_solver::C_solver_outputs::DISPATCH_PRES_NVAR,
                 C_csp_reported_outputs::TS_1ST},          //[-] Number of variables in dispatch model formulation
                {C_csp_solver::C_solver_outputs::DISPATCH_SOLVE_TIME,
                 C_csp_reported_outputs::TS_1ST},          //[sec]   Time required to solve the dispatch model at each instance
                ...
                {C_csp_solver::C_solver_outputs::BEAM,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},            //[W/m^2] Resource beam normal irradiance
                ...
                {C_csp_solver::C_solver_outputs::CR_DEFOCUS,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},        //[-] Field optical focus fraction
                ...
                {C_csp_solver::C_solver_outputs::TES_W_DOT_HEATER,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},      //[MWe] TES freeze protection power
                {C_csp_solver::C_solver_outputs::TES_T_HOT,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},              //[C] TES final hot tank temperature
                {C_csp_solver::C_solver_outputs::TES_T_COLD,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},              //[C] TES final cold tank temperature
                {C_csp_solver::C_solver_outputs::TES_Q_DOT_DC,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},          //[MWt] TES discharge thermal power
                ...
                {C_csp_solver::C_solver_outputs::TES_E_CH_STATE,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},          //[MWht] TES charge state at the end of the time step
                {C_csp_solver::C_solver_outputs::TES_M_DOT_DC,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},          //[MWt] TES discharge mass flow rate
                ...
                {C_csp_solver::C_solver_outputs::COL_W_DOT_TRACK,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},      //[MWe] Parasitic collector tracking, startup, stow power consumption
                {C_csp_solver::C_solver_outputs::CR_W_DOT_PUMP,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},          //[MWe] Parasitic tower HTF pump power
                {C_csp_solver::C_solver_outputs::SYS_W_DOT_PUMP,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},          //[MWe] Parasitic PC and TES HTF pump power
                {C_csp_solver::C_solver_outputs::PC_W_DOT_COOLING,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},      //[MWe] Parasitic condenser operation power
                {C_csp_solver::C_solver_outputs::SYS_W_DOT_FIXED,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},      //[MWe] Parasitic fixed power consumption
                {C_csp_solver::C_solver_outputs::SYS_W_DOT_BOP,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},          //[MWe] Parasitic BOP power consumption
                {C_csp_solver::C_solver_outputs::W_DOT_NET,
                 C_csp_reported_outputs::TS_WEIGHTED_AVE},              //[MWe] System total electric power to grid
...
void C_csp_solver::init() {
    ...
    if (mc_collector_receiver.m_is_sensible_htf != mc_power_cycle.m_is_sensible_htf) {
        throw (C_csp_exception(
                "The collector-receiver and power cycle models have incompatible HTF - direct/indirect assumptions",
                "CSP Solver"));
    }
...
void C_csp_solver::Ssimulate(C_csp_solver::S_sim_setup &sim_setup,
                             bool(*mf_callback)(void *data, double percent, C_csp_messages *csp_messages,
                                                float time_sec),
                             void *m_cdata) {
    // Get number of records in weather file
    int n_wf_records = mc_weather.get_n_records();
    ...
    double wf_step = 3600.0 /
                     step_per_hour;    //[s] Weather file time step - would like to check this against weather file, some day
    ...
    if (mc_tou.mc_dispatch_params.m_dispatch_optimize) {
        ...
        for (int i = 0; i < neff; i++) {
            double x = dispatch.params.q_pb_min +
                       (dispatch.params.q_pb_max - dispatch.params.q_pb_min) / (double) (neff - 1) * i;
    ...
    */
    ...
    while (mc_kernel.mc_sim_info.ms_ts.m_time <= mc_kernel.get_sim_setup()->m_sim_time_end) {
        ...
        double calc_frac_current = (mc_kernel.mc_sim_info.ms_ts.m_time - mc_kernel.get_sim_setup()->m_sim_time_start) /
        ...
        if (calc_frac_current > progress_msg_frac_current) {
            if (!
                    mf_callback(m_cdata, (float) calc_frac_current * 100.f, &mc_csp_messages,
        ...
        if (cr_operating_state < C_csp_collector_receiver::OFF ||
            ...
            std::string msg = util::format("The collector-receiver operating state at time %lg [hr] is %d. Recognized"
                                           " values are from %d to %d\n", mc_kernel.mc_sim_info.ms_ts.m_step / 3600.0,
                                           cr_operating_state, C_csp_collector_receiver::OFF,
        ...
        if (m_is_tes) {
            ...
            mc_tes.discharge_avail_est(T_htf_cold_guess + 273.15, mc_kernel.mc_sim_info.ms_ts.m_step, q_dot_tes_dc,
            ...
            mc_tes.charge_avail_est(T_htf_hot_cr_on + 273.15, mc_kernel.mc_sim_info.ms_ts.m_step, q_dot_tes_ch,
        ...
        if (mc_tou.mc_dispatch_params.m_is_block_dispatch) {
            ...
            if (mc_tou.mc_dispatch_params.m_use_rule_1 &&
                (mc_kernel.mc_sim_info.ms_ts.m_time + mc_tou.mc_dispatch_params.m_standby_off_buffer <=
            ...
            if (mc_tou.mc_dispatch_params.m_use_rule_2 &&
                ((q_pc_target < q_pc_min &&
                  q_dot_tes_ch < m_q_dot_rec_des * mc_tou.mc_dispatch_params.m_q_dot_rec_des_mult) ||
        ...
        if (mc_tou.mc_dispatch_params.m_dispatch_optimize) {
            ...
            if ((int) mc_kernel.mc_sim_info.ms_ts.m_time %
                (int) (3600. * mc_tou.mc_dispatch_params.m_optimize_frequency) == baseline_step
                ...
                for (int t = 0; t < opt_horizon * mc_tou.mc_dispatch_params.m_disp_steps_per_hour; t++) {
                    mc_tou.call(mc_kernel.mc_sim_info.ms_ts.m_time +
                                t * 3600. / (double) mc_tou.mc_dispatch_params.m_disp_steps_per_hour, mc_tou_outputs);
                ...
                for (int t = 0; t < opt_horizon; t++) {
                    for (int d = 0; d < mc_tou.mc_dispatch_params.m_disp_steps_per_hour; d++)
                        dispatch.w_lim.at(t * mc_tou.mc_dispatch_params.m_disp_steps_per_hour +
                                          d) = mc_tou.mc_dispatch_params.m_w_lim_full.at(hour_start + t);
                }
                ...
                dispatch.params.is_rec_operating0 =
                        mc_collector_receiver.get_operating_state() == C_csp_collector_receiver::ON;
                ...
                mc_tes.discharge_avail_est(m_T_htf_cold_des, mc_kernel.mc_sim_info.ms_ts.m_step, q_disch, m_dot_disch,
                                           T_tes_return);
                dispatch.params.e_tes_init = q_disch * 1000. * mc_kernel.mc_sim_info.ms_ts.m_step / 3600. +
            ...
            if (
                ...
                dispatch.m_current_read_step =
                        (int) (mc_kernel.mc_sim_info.ms_ts.m_time * mc_tou.mc_dispatch_params.m_disp_steps_per_hour /
                               3600. - .001)
                        % (mc_tou.mc_dispatch_params.m_optimize_frequency *
				...
				*/
                ...
                if (dispatch.w_lim.at(dispatch.m_current_read_step) < 1.e-6)
                    ...
                    while (eta_diff > 0.001 && i < 20) {
                        double q_pc_est = dispatch.w_lim.at(dispatch.m_current_read_step) * 1.e-3 /
                                          eta_calc;            // Estimated power cycle thermal input at w_lim
                        double eta_new = mc_power_cycle.get_efficiency_at_load(
                                q_pc_est / m_cycle_q_dot_des);        // Calculated power cycle efficiency
                        eta_diff = fabs(eta_calc - eta_new);
                        eta_calc = eta_new;
                        i++;
                    }
                    q_pc_max = fmin(q_pc_max, dispatch.w_lim.at(dispatch.m_current_read_step) * 1.e-3 /
                                              eta_calc); // Restrict max pc thermal input to *approximate* current allowable value (doesn't yet account for parasitics)
                    q_pc_max = fmax(q_pc_max,
                                    q_pc_target);                                                    // calculated q_pc_target accounts for parasitics --> can be higher than approximate limit
                }
                ...
                disp_etapb_expect =
                        disp_wpb_expect / max(1.e-6, dispatch.outputs.q_pb_target.at(dispatch.m_current_read_step)) *
                        1.e3
                ...
                if (dispatch.m_current_read_step >
                    ...
                    throw C_csp_exception("Counter synchronization error in dispatch optimization routine.",
                                          "dispatch");
            }
        ...
        */
        ...
        if ((cr_operating_state == C_csp_collector_receiver::OFF ||
            ...
            if (mc_cr_out_solver.m_q_startup == 0.0 || mc_cr_out_solver.m_time_required_su !=
                                                       mc_cr_out_solver.m_time_required_su) {    // Collector/receiver can't produce useful energy
                ...
                if (m_is_tes) {
                    double m_dot_field_dc_est, T_hot_field_dc_est;    //[kg/s, K]
                    m_dot_field_dc_est = T_hot_field_dc_est = std::numeric_limits<double>::quiet_NaN();
                    mc_tes.discharge_avail_est(m_T_htf_cold_des, t_CR_su, q_dot_tes_dc_t_CR_su, m_dot_field_dc_est,
                                               T_hot_field_dc_est);
                } else {
        ...
        while (!are_models_converged)        // Solve for correct operating mode and performance in following loop:
        {
            ...
            mc_kernel.mc_sim_info.ms_ts.m_step =
                    mc_kernel.mc_sim_info.ms_ts.m_time - mc_kernel.mc_sim_info.ms_ts.m_time_start;

            if ((cr_operating_state == C_csp_collector_receiver::OFF ||
                 cr_operating_state == C_csp_collector_receiver::STARTUP)
                && (pc_operating_state == C_csp_power_cycle::OFF || pc_operating_state ==
                                                                    C_csp_power_cycle::STARTUP)) {    // At start of this timestep, are power cycle AND collector/receiver off?

                if (q_dot_cr_startup > 0.0 && is_rec_su_allowed &&
                    m_is_CR_SU__PC_OFF__TES_OFF__AUX_OFF_avail) {    // Receiver startup is allowed and possible (will generate net energy)
                ...
                if (q_dot_cr_on > 0.0 &&
                    is_rec_su_allowed) {    // Receiver is allowed to remain on, and it can produce useful energy. Now, need to find a home for it
                ...
                if (q_dot_cr_startup > 0.0 &&
                    is_rec_su_allowed) {    // Receiver startup is allowed and possible (will generate net energy) - determine if power cycle can remain on

                    if (is_pc_su_allowed || is_pc_sb_allowed) {
                        if (q_dot_tes_dc_t_CR_su * (1.0 + tol_mode_switching) > q_pc_target && is_pc_su_allowed &&
                            m_is_CR_SU__PC_TARGET__TES_DC__AUX_OFF_avail) {    // Tolerance is applied so that if TES is *close* to matching target, the controller tries that mode
                            ...
                            operating_mode = CR_SU__PC_TARGET__TES_DC__AUX_OFF;
                                   ...
                                   m_is_CR_SU__PC_RM_LO__TES_EMPTY__AUX_OFF_avail) {    // Tolerance is applied so that if TES is *close* to reaching min fraction, the controller tries that mode
                            ...
                            operating_mode = CR_SU__PC_RM_LO__TES_EMPTY__AUX_OFF;
                                   ...
                                   m_is_CR_SU__PC_SB__TES_DC__AUX_OFF_avail) {    // Tolerance is applied so that if TES is *close* to reaching min fraction, the controller tries that mode
                ...
                } else    // Receiver remains OFF - determine if power cycle can remain on
                {
                    if (is_pc_su_allowed || is_pc_sb_allowed) {
                        ...
                        if (q_dot_tes_dc * (1.0 + tol_mode_switching) > q_pc_target && is_pc_su_allowed &&
                            m_is_CR_OFF__PC_TARGET__TES_DC__AUX_OFF_avail) {    // Tolerance is applied so that if TES is *close* to matching target, the controller tries that mode

                            operating_mode = CR_OFF__PC_TARGET__TES_DC__AUX_OFF;
                        } else if (q_dot_tes_dc * (1.0 + tol_mode_switching) > q_pc_min && is_pc_su_allowed &&
                                   m_is_CR_OFF__PC_RM_LO__TES_EMPTY__AUX_OFF_avail) {    // Tolerance is applied so that if TES is *close* to reaching min fraction, the controller tries that mode

                            operating_mode = CR_OFF__PC_RM_LO__TES_EMPTY__AUX_OFF;
                        } else if (is_pc_sb_allowed && q_dot_tes_dc * (1.0 + tol_mode_switching) > q_pc_sb &&
                                   m_is_CR_OFF__PC_SB__TES_DC__AUX_OFF_avail) {    // Tolerance is applied so that if TES is *close* to reaching min fraction, the controller tries that mode
                       ...
                       (pc_operating_state == C_csp_power_cycle::ON ||
                        pc_operating_state == C_csp_power_cycle::STANDBY)) {
                if (q_dot_cr_on > 0.0 &&
                    is_rec_su_allowed) {    // Receiver operation is allowed and possible - find a home for output

                    if (is_pc_su_allowed || is_pc_sb_allowed) {
                        if (q_dot_cr_on * (1.0 + tol_mode_switching) > q_pc_target && is_pc_su_allowed &&
                            m_is_CR_ON__PC_RM_HI__TES_OFF__AUX_OFF_avail_LO_SIDE &&
                            m_is_CR_ON__PC_TARGET__TES_CH__AUX_OFF_avail_LO_SIDE) {    // The power cycle cannot accept the entire receiver output
                            ...
                            if (q_dot_tes_ch > 0.0) {
                                ...
                                if ((q_dot_cr_on - q_dot_tes_ch) * (1.0 - tol_mode_switching) < q_pc_target &&
                                    ...
                                    // Assume we want to completely fill storage, so the power cycle operation should float to meet that condition
                                         ...
                                         m_is_CR_ON__PC_RM_HI__TES_FULL__AUX_OFF_avail) {    // Storage and the power cycle operating between target and max can accept the remaining receiver output
                        ...
                        } else {    // Power cycle is asking for more output than the receiver can supply

                            if (q_dot_tes_dc > 0.0) {    // Storage dispatch is available

                                if ((q_dot_cr_on + q_dot_tes_dc) * (1.0 + tol_mode_switching) > q_pc_target &&
                                    is_pc_su_allowed &&
                                    m_is_CR_ON__PC_TARGET__TES_DC__AUX_OFF_avail) {    // Storage can provide enough dispatch to reach power cycle target
                                    // Tolerance is applied so that if CR + TES is *close* to reaching PC target, the controller tries that mode

                                    operating_mode = CR_ON__PC_TARGET__TES_DC__AUX_OFF;
                                } else if ((q_dot_cr_on + q_dot_tes_dc) * (1.0 + tol_mode_switching) > q_pc_min &&
                                           is_pc_su_allowed &&
                                           m_is_CR_ON__PC_RM_LO__TES_EMPTY__AUX_OFF_avail) {    // Storage can provide enough dispatch to at least meet power cycle minimum operation fraction
                                    ...
                                    if (q_dot_tes_ch > 0.0) {
                                        if ((q_dot_cr_on - q_dot_tes_ch) * (1.0 + tol_mode_switching) > q_pc_sb &&
                                            m_is_CR_ON__PC_SB__TES_FULL__AUX_OFF_avail) {    // Tolerance is applied so that if CR output is *close* to operating at standby AND completely filling storage, controller tries that mode
                                ...
                                if (q_dot_cr_on * (1.0 + tol_mode_switching) > q_pc_min && is_pc_su_allowed &&
                                    m_is_CR_ON__PC_RM_LO__TES_OFF__AUX_OFF_avail) {    // Tolerance is applied so that if CR is *close* to reaching PC min, the controller tries that mode

                                    operating_mode = CR_ON__PC_RM_LO__TES_OFF__AUX_OFF;
                                } else if (is_pc_sb_allowed && q_dot_cr_on * (1.0 + tol_mode_switching) > q_pc_sb &&
                                           m_is_CR_ON__PC_SB__TES_OFF__AUX_OFF_avail &&
                                           m_is_CR_ON__PC_SB__TES_CH__AUX_OFF_avail) {    // Receiver can likely operate in standby
                                    ...
                                    if (q_dot_cr_on * (1.0 + tol_mode_switching) > q_pc_sb &&
                                        m_is_CR_ON__PC_SB__TES_OFF__AUX_OFF_avail) {    // Tolerance is applied so that if CR output is *close* to reaching standby, the controller tries that mode
                                ...
                                } else if (q_dot_tes_ch > 0.0) {    // Charge storage with receiver output

                                    if (q_dot_cr_on * (1.0 - tol_mode_switching) < q_dot_tes_ch &&
                                        m_is_CR_ON__PC_OFF__TES_CH__AUX_OFF_avail) {    // Tolerance is applied so that if CR is *close* to being less than a full TES charge, the controller tries normal operation (no defocus)


                                        operating_mode = CR_ON__PC_OFF__TES_CH__AUX_OFF;
                                    } else if (m_is_CR_DF__PC_OFF__TES_FULL__AUX_OFF_avail) {    // The CR output will overcharge storage, so it needs to defocus.
                                ...
                                } else {    // No home for receiver output, and not enough thermal power for power cycle
                    ...
                    else {    // Power cycle startup is not allowed - see if receiver output can go to storage
                ...
                else    // Receiver is off - determine if power cycle can remain on
                {
                    if (is_pc_su_allowed || is_pc_sb_allowed) {
                        if (q_dot_tes_dc > 0.0) {    // Storage dispatch is available
                            ...
                            if (q_dot_tes_dc * (1.0 + tol_mode_switching) > q_pc_target && is_pc_su_allowed &&
                                m_is_CR_OFF__PC_TARGET__TES_DC__AUX_OFF_avail) {    // Storage can provide enough dispatch to reach power cycle target
                                // Tolerance is applied so that if TES is *close* to reaching PC target, the controller tries that mode

                                operating_mode = CR_OFF__PC_TARGET__TES_DC__AUX_OFF;
                            } else if (q_dot_tes_dc * (1.0 + tol_mode_switching) > q_pc_min && is_pc_su_allowed &&
                                       m_is_CR_OFF__PC_RM_LO__TES_EMPTY__AUX_OFF_avail) {    // Storage can provide enough dispatch to at least meet power cycle minimum operation fraction
                                // Run at highest possible PC fraction by dispatching all remaining storage
                                // Tolerance is applied so that if CR + TES is *close* to reaching PC min, the controller tries that mode

                                operating_mode = CR_OFF__PC_RM_LO__TES_EMPTY__AUX_OFF;
                            } else if (is_pc_sb_allowed && q_dot_tes_dc * (1.0 + tol_mode_switching) > q_pc_sb &&
                                       m_is_CR_OFF__PC_SB__TES_DC__AUX_OFF_avail) {    // Tolerance is applied so that if CR + TES is *close* to reaching standby, the controller tries that mode

                                operating_mode = CR_OFF__PC_SB__TES_DC__AUX_OFF;
                            } else if (is_pc_su_allowed &&
                                       m_is_CR_OFF__PC_MIN__TES_EMPTY__AUX_OFF_avail) {    // If not enough thermal power to stay in standby, then run at min PC load until TES is fully discharged
                    ...
                    else {    // If neither receiver nor power cycle operation is allowed, then shut everything off
            ...
            switch (operating_mode) {
                ...
                case CR_DF__PC_MAX__TES_OFF__AUX_OFF: {
                    ...
                    if (!mc_collector_receiver.m_is_sensible_htf) {
                        std::string err_msg = util::format("Operating mode, %d, is not configured for DSG mode",
                                                           operating_mode);
                    ...
                    if (df_code != 0) {
                        ...
                        error_msg = util::format(
                                "At time = %lg the controller chose Defocus operating mode, but the collector/receiver"
                    ...
                    if (defocus_guess_q_dot < 1.0 || defocus_guess_m_dot < 1.0) {    // Need to defocus
                        ...
                        if (is_df_q_dot) {
                            ...
                            xy_pair_df1.y =
                                    (m_dot_cr_df1 - mc_pc_out_solver.m_m_dot_htf) / mc_pc_out_solver.m_m_dot_htf;
                        }
                        ...
                        df_code = 0;
                        try {
                            df_code = c_df_solver.solve(xy_pair_df1, xy_pair_df2, 0.0 - tol_df_solver, defocus_solved,
                        ...
                        if (df_code != C_monotonic_eq_solver::CONVERGED) {
                            if (pc_mode == C_csp_power_cycle::ON) {
                                throw (C_csp_exception(util::format(
                                        "At time = %lg Solver tried mode 'CR_DF__PC_MAX__TES_OFF__AUX_OFF' and did not receive useful exit instructions",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0), "CSP Solver"));
                            } else if (pc_mode == C_csp_power_cycle::STARTUP_CONTROLLED) {
                                throw (C_csp_exception(util::format(
                                        "At time = %lg Solver tried mode 'CR_DF__PC_SU__TES_OFF__AUX_OFF' and did not receive useful exit instructions",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0), "CSP Solver"));
                            }
                        }
                    ...
                    if (m_is_tes) {
                        mc_tes.idle(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                                    mc_tes_outputs);
                ...
                case CR_ON__PC_RM_LO__TES_OFF__AUX_OFF: {
                    ...
                    if (exit_mode == POOR_CONVERGENCE) {
                        if (fabs(exit_tolerance) >
                            relaxed_tol) {    // Did not converge within Relaxed Tolerance, shut off CR and PC

                            // update 'exit_mode'
                            exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                        } else {    // Convergence within Relaxed Tolerance, *Report message* but assume timestep solved in this mode

                            error_msg = util::format(
                                    "At time = %lg the collector/receiver and power cycle solution only reached a convergence"
                    ...
                    if (exit_mode ==
                        C_csp_solver::CSP_NO_SOLUTION) {    // Either CR & PC did not solve/produce power, or did not solve within Relaxed Tolerance: shut off CR and PC
                        ...
                        if (operating_mode ==
                            CR_ON__PC_RM_LO__TES_OFF__AUX_OFF) {    // In this mode, the power cycle thermal input needs to be greater than the minimum power cycle fraction
                            ...
                            if (mc_cr_out_solver.m_q_thermal < q_pc_min) {
                                ...
                                break;
                                   ...
                                   CR_ON__PC_RM_HI__TES_OFF__AUX_OFF) {    // In this mode, the power cycle thermal input needs to be greater than the target cycle fraction
                        ...
                        throw (C_csp_exception(
                                "Solver tried mode 'CR_ON__PC_RM__TES_OFF__AUX_OFF' and did not receive exit instructions",
                                "CSP Solver"));
                    }
                ...
                case CR_ON__PC_SB__TES_OFF__AUX_OFF:
                    ...
                    if (mc_cr_out_solver.m_q_thermal < q_pc_sb) {    // Collector/receiver can't produce useful energy
                ...
                case CR_ON__PC_SU__TES_OFF__AUX_OFF:
                    ...
                    if (mc_cr_out_solver.m_q_thermal == 0.0) {    // Collector/receiver can't produce useful energy
                    ...
                    if (mc_cr_out_solver.m_q_thermal > q_dot_pc_su_max && q_dot_tes_ch > 0.0) {
                        error_msg = util::format(
                                "At time = %lg CR_ON__PC_SU__TES_OFF__AUX_OFF method converged to a power cycle"
                ...
                case CR_SU__PC_OFF__TES_OFF__AUX_OFF:
                    ...
                    // Check that startup happened
                    if (mc_cr_out_solver.m_q_startup == 0.0) {    // Collector/receiver can't produce useful energy
                ...
                case CR_ON__PC_OFF__TES_CH__AUX_OFF: {
                    ...
                    while (fabs(diff_T_rec_in) > tol || diff_T_rec_in != diff_T_rec_in) {
                        ...
                        if (diff_T_bounds / T_rec_in_upper < tol / 2.0) {
                            if (diff_T_rec_in !=
                                diff_T_rec_in) {    // Models aren't producing power or are returning errors, and it appears we've tried the solution space for T_rec_in

                                exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                                exit_tolerance = diff_T_rec_in;
                                return;
                            } else {    // Models are producing power, but convergence errors are not within Tolerance
                        ...
                        if (iter_T_rec_in > 1) {
                            ...
                            //***********************
                            if (diff_T_rec_in !=
                                diff_T_rec_in) {    // Models did not solve such that a convergence error could be generated
                            ...
                            } else if (diff_T_rec_in > 0.0)        // Guess receiver inlet temperature was too low
                            {
                                ...
                                if (is_upper_bound && is_upper_error)        // False-position method
                                {
                                    T_rec_in_guess = y_rec_in_upper / (y_rec_in_upper - y_rec_in_lower) *
                                                     (T_rec_in_lower - T_rec_in_upper) + T_rec_in_upper;    //[C]
                        ...
                        if (mc_cr_out_solver.m_m_dot_salt_tot == 0.0 || mc_cr_out_solver.m_q_thermal == 0.0) {
                            ...
                            if (iter_T_rec_in == 1) {
                                ...
                                exit_tolerance = diff_T_rec_in;
                                break;
                            } else {    // Set this T_rec_in_guess as either upper or lower bound, depending on which end of DESIGN temp it falls
                        ...
                        bool tes_charge_success = mc_tes.charge(mc_kernel.mc_sim_info.ms_ts.m_step,
                        ...
                        if (!tes_charge_success) {    // If receiver output overcharges storage during iteration, then assume we need some defocus and break loop
                    ...
                    if (exit_mode == POOR_CONVERGENCE) {
                        if (fabs(exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg the collector/receiver and thermal storage charging method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, exit_tolerance);
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                    ...
                    if (exit_mode ==
                        C_csp_solver::CSP_NO_SOLUTION) {    // This mode did not solve, and did not provide enough information to try other operating mode. Shut plant off
                    ...
                    if (exit_mode !=
                        C_csp_solver::CSP_CONVERGED) {    // All other options should be exhausted, so if not CONVERGED, something is wrong. Shut down plant
                ...
                case CR_ON__PC_TARGET__TES_CH__AUX_OFF: {
                    ...
                    double tol = 1.0 /
                                 m_cycle_T_htf_hot_des;    //[-] Relative error corresponding to 1 C temperature difference
                    ...
                    if (q_pc_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(q_pc_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_TARGET__TES_CH__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                    ...
                    if (q_pc_exit_mode == UNDER_TARGET_PC || q_pc_exit_mode == C_csp_solver::CSP_NO_SOLUTION ||
                        T_rec_in_exit_mode == C_csp_solver::CSP_NO_SOLUTION) {
                        m_is_CR_ON__PC_TARGET__TES_CH__AUX_OFF_avail_LO_SIDE = false;
                        are_models_converged = false;
                        break;
                ...
                case CR_ON__PC_TARGET__TES_DC__AUX_OFF: {
                    ...
                    if (q_pc_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(q_pc_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_TARGET__TES_DC__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, q_pc_exit_tolerance);
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                    ...
                    if (q_pc_exit_mode == OVER_TARGET_PC) {
                        error_msg = util::format(
                                "At time = %lg CR_ON__PC_TARGET__TES_DC__AUX_OFF method converged to a power cycle"
                                " thermal input greater than the target.",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                        mc_csp_messages.add_message(C_csp_messages::NOTICE, error_msg);
                ...
                case CR_ON__PC_RM_LO__TES_EMPTY__AUX_OFF: {
                    ...
                    while (fabs(diff_T_rec_in) > tol || diff_T_rec_in != diff_T_rec_in) {
                        ...
                        if (iter_T_rec_in > 1) {    // diff_T_rec_in = (T_rec_in_calc - T_rec_in_guess)/T_rec_in_guess

                            if (diff_T_rec_in !=
                                diff_T_rec_in) {    // Models did not solve such that a convergence error could be calculated
                        ...
                        if (mc_cr_out_solver.m_m_dot_salt_tot == 0.0 || mc_cr_out_solver.m_q_thermal == 0.0) {
                            ...
                            if (iter_T_rec_in == 1) {
                            ...
                            } else {    // If collector-receiver model has solved with results previously in this loop, then try to find another guess value
                                ...
                                if (T_rec_in_guess <
                                    T_rec_in_guess_ini) {    // If current guess value is less than the initial guess value, then:
                        ...
                        mc_tes.discharge_full(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                                              T_rec_in_guess + 273.15, T_tes_htf_hot, m_dot_tes_dc, mc_tes_outputs);
                        ...
                        double T_pc_htf_in = (m_dot_tes_dc * T_tes_htf_hot +
                                              mc_cr_out_solver.m_m_dot_salt_tot * mc_cr_out_solver.m_T_salt_hot) /
                                             (m_dot_pc);    //[C]
                    ...
                    if (mc_pc_out_solver.m_q_dot_htf > q_pc_target) {
                        error_msg = util::format(
                                "At time = %lg CR_ON__PC_RM_LO__TES_EMPTY__AUX_OFF method converged to a power cycle"
                                " thermal input greater than the target.",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                        mc_csp_messages.add_message(C_csp_messages::NOTICE, error_msg);
                    }
                    ...
                    // Handle exit modes
                    if (exit_mode == POOR_CONVERGENCE) {
                        if (fabs(exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance

                            // update 'exit_mode'
                            exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                        } else {    // Convergence within Relaxed Tolerance, *Report message* but assume timestep solved in this mode
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_RM_LO__TES_EMPTY__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, exit_tolerance);
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                ...
                case CR_DF__PC_OFF__TES_FULL__AUX_OFF: {
                    ...
                    if (mc_cr_out_solver.m_q_thermal == 0.0) {
                        ...
                        // Weird that controller chose Defocus operating mode, so report message and shut down CR and PC
                        error_msg = util::format(
                                "At time = %lg the controller chose CR_DF__PC_OFF__TES_FULL__AUX_OFF, but the collector/receiver"
                                "did not produce power with the design inlet temperature. Controller will shut-down CR and PC",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                        mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                    ...
                    mc_tes.charge_full(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                                       m_T_htf_cold_des,
                    ...
                    double diff_m_dot = 999.9 *
                                        tol;            // (m_dot_rec - m_dot_tes)/m_dot_tes: (+) q_dot too large, decrease defocus, (-) q_dot too small, increase defocus fraction
                    ...
                    while (fabs(diff_m_dot) > tol || diff_m_dot != diff_m_dot) {
                        ...
                        if (diff_defocus_bounds / defocus_upper < tol / 2.0) {
                            if (diff_m_dot != diff_m_dot) {    // CR-PC aren't converging, so need to shut them down

                                defocus_exit_tolerance = std::numeric_limits<double>::quiet_NaN();
                                defocus_exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                                break;        // Get out of while()
                            } else {    // Poor convergence between power delivered to PC and power requested
                        ...
                        if (iter_defocus > 1) {
                            ...
                            } else if (diff_m_dot > 0.0)        // q_dot was too high, decrease defocus
                            {
                                ...
                                {
                                    defocus_guess = y_defocus_uppper / (y_defocus_uppper - y_defocus_lower) *
                                                    (defocus_lower - defocus_upper) + defocus_upper;
                                } else if (is_defocus_lower_bound) {
                                    defocus_guess = 0.5 * (defocus_upper + defocus_lower);
                                } else {
                                    defocus_guess = fmax(0.01, defocus_guess -
                                                               0.05);            // Could perhaps use last solution to make a smarter guess...
                                }
                            ...
                            } else                            // q_dot was too low, increase defocus
                            {
                                ...
                                if (is_defocus_upper_bound && is_defocus_upper_error) {
                                    defocus_guess = y_defocus_uppper / (y_defocus_uppper - y_defocus_lower) *
                                                    (defocus_lower - defocus_upper) + defocus_upper;
                                } else if (is_defocus_upper_bound) {    // should always have upper bound, but keep this framework for consistency...
                                    defocus_guess = 0.5 * (defocus_upper + defocus_lower);
                                } else {
                        ...
                        while (fabs(diff_T_rec_in) > tol_T_rec_in || diff_T_rec_in != diff_T_rec_in) {
                            ...
                            if (iter_T_rec_in >
                                ...
                                } else if (diff_T_rec_in > 0.0)        // Guess receiver inlet temperature was too low
                                {
                                    ...
                                    if (is_T_rec_upper_bound && is_T_rec_upper_error) {
                                        T_rec_in_guess = y_T_rec_in_upper / (y_T_rec_in_upper - y_T_rec_in_lower) *
                            ...
                            if (mc_cr_out_solver.m_m_dot_salt_tot == 0.0 || mc_cr_out_solver.m_q_thermal == 0.0) {
                                ...
                                if (iter_T_rec_in == 1) {
                                    ...
                                    T_rec_in_exit_tolerance = std::numeric_limits<double>::quiet_NaN();
                                    break;  // exit while() on diff_T_rec_in and enter while() on defocus
                                } else {    // If collector-receiver model has solved with results previously, then try to find another guess value
                                    // Assumption here is that the receiver solved at the first guess temperature: 'T_rec_in_guess_ini'
                                    // Also, assume that if both upper and lower bounds exist, then can't generate a new guess
                                    if (T_rec_in_guess <
                                        T_rec_in_guess_ini) {    // If current guess value is less than initial value, then:
                            ...
                            mc_tes.charge_full(mc_kernel.mc_sim_info.ms_ts.m_step,
                                               mc_weather.ms_outputs.m_tdry + 273.15, T_htf_rec_out + 273.15,
                        ...
                        diff_m_dot = (mc_cr_out_solver.m_m_dot_salt_tot - mc_tes_ch_htf_state.m_m_dot) /
                    ...
                    if (T_rec_in_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_rec_in_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_DF__PC_OFF__TES_FULL__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, T_rec_in_exit_tolerance);
                ...
                case CR_SU__PC_SB__TES_DC__AUX_OFF: {
                    ...
                    mc_tes.discharge_full(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                                          m_T_htf_cold_des, T_htf_hot_out, m_dot_htf_max, mc_tes_outputs);
                    ...
                    while (fabs(diff_q_dot) > tol || diff_q_dot != diff_q_dot) {
                        ...
                        if (diff_q_dot_bounds < bounds_tol) {
                            if (diff_q_dot != diff_q_dot) {    // Unable to solve TES model...
                                ...
                                break;        // get out of while()
                            } else {    // Poor convergence between power discharged from TES and PC standby
                        ...
                        if (iter_q_dot > 1) {
                            if (diff_q_dot !=
                                diff_q_dot)        // Check if solution was found during previous iteration
                            {    // TES did not solve, so don't know how result of previous m_dot_guess
                                ...
                                m_dot_dc_guess = 0.5 * (m_dot_lower + m_dot_upper);
                                       ...
                                       0.0)        // q_dot calculated was too large, decrease mass flow rate
                            {
                                is_upper_bound = true;
                                is_upper_error = true;
                                ...
                                if (is_lower_bound && is_lower_error)    // False-position method
                                {
                                    m_dot_dc_guess = y_m_dot_upper / (y_m_dot_upper - y_m_dot_lower) *
                                                     (m_dot_lower - m_dot_upper) + m_dot_upper;
                                } else if (is_lower_bound) {
                                    m_dot_dc_guess = 0.5 * (m_dot_lower + m_dot_upper);
                                } else {
                                    m_dot_dc_guess *= 0.5;
                        ...
                        // Solve TES discharge
                        bool is_tes_success = mc_tes.discharge(mc_kernel.mc_sim_info.ms_ts.m_step,
                        ...
                        if (!is_tes_success) {    // TES did not solve with this iteration's mass flow rate
                    ...
                    if (q_dot_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance
                            ...
                            if (operating_mode == CR_OFF__PC_SB__TES_DC__AUX_OFF) {
                                error_msg = util::format(
                                        "At time = %lg CR_OFF__PC_SB__TES_DC__AUX_OFF method only reached a convergence"
                                        "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, exit_tolerance);
                            } else if (operating_mode == CR_SU__PC_SB__TES_DC__AUX_OFF) {
                                error_msg = util::format(
                                        "At time = %lg CR_SU__PC_SB__TES_DC__AUX_OFF method only reached a convergence"
                                        "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, exit_tolerance);
                            }
                    ...
                    mc_pc_htf_state_in.m_temp =
                            T_htf_hot_out - 273.15;        //[C], convert from K: average storage discharge temperature
                ...
                case CR_OFF__PC_MIN__TES_EMPTY__AUX_OFF: {
                    ...
                    // Handle exit modes from outer and inner loops
                    if (q_pc_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(q_pc_exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance

                            q_pc_exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                        } else {    // Convergence within Relaxed Tolerance, *Report message* but assume timestep solved in this mode
                            error_msg = util::format(
                                    "At time = %lg CR_OFF__PC_MIN__TES_EMPTY__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, q_pc_exit_tolerance);
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                    ...
                    if (time_tes_dc > mc_kernel.mc_sim_info.ms_ts.m_step) {
                        error_msg = util::format(
                                "At time = %lg CR_OFF__PC_MIN__TES_EMPTY__AUX_OFF method calculated a timestep"
                ...
                case CR_SU__PC_RM_LO__TES_EMPTY__AUX_OFF: {
                    ...
                    while (fabs(diff_T_tes_cold) > tol || diff_T_tes_cold != diff_T_tes_cold) {
                        ...
                        if (diff_T_bounds / T_tes_cold_upper < tol / 2.0) {
                            if (diff_T_tes_cold !=
                                diff_T_tes_cold) {    // Models aren't producing power or are returning errors, and it appears we've tried the solution space for T_tes_cold
                        ...
                        if (iter_T_tes_cold >
                            1) {    // diff_T_tes_cold = (T_tes_cold_calc - T_tes_cold_guess)/T_tes_cold_guess

                            if (diff_T_tes_cold !=
                                diff_T_tes_cold) {    // Models did not solve such that a convergence error could be calculated
                                // However, we can check whether upper and lower bounds are set, and may be able to calculate a new guess via bisection method
                                // But, check that bounds exist
                                if (!is_lower_bound || !is_upper_bound) {
                            ...
                            } else if (diff_T_tes_cold > 0.0)        // Guess cold temperature was too low
                            {
                                ...
                                if (is_upper_bound && is_upper_error) {
                                    T_tes_cold_guess = y_T_tes_cold_upper / (y_T_tes_cold_upper - y_T_tes_cold_lower) *
                        ...
                        mc_tes.discharge_full(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                                              T_tes_cold_guess + 273.15, T_htf_tes_hot, m_dot_tes_dc, mc_tes_outputs);
                    ...
                    if (exit_mode == POOR_CONVERGENCE) {
                        if (fabs(exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance
                            ...
                            if (operating_mode == CR_OFF__PC_RM_LO__TES_EMPTY__AUX_OFF) {
                                error_msg = util::format(
                                        "At time = %lg CR_OFF__PC_RM_LO__TES_EMPTY__AUX_OFF method only reached a convergence"
                                        "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, exit_tolerance);
                            } else if (operating_mode == CR_SU__PC_RM_LO__TES_EMPTY__AUX_OFF) {
                                error_msg = util::format(
                                        "At time = %lg CR_SU__PC_RM_LO__TES_EMPTY__AUX_OFF method only reached a convergence"
                                        "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, exit_tolerance);
                            }
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                ...
                case CR_ON__PC_SB__TES_CH__AUX_OFF: {
                    ...
                    if (q_pc_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(q_pc_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_SB__TES_CH__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, q_pc_exit_tolerance);
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                ...
                case CR_SU__PC_MIN__TES_EMPTY__AUX_OFF: {
                    ...
                    if (q_pc_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(q_pc_exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_SU__PC_MIN__TES_EMPTY__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, q_pc_exit_tolerance);
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                    ...
                    if (time_tes_dc > mc_kernel.mc_sim_info.ms_ts.m_step) {
                        error_msg = util::format(
                                "At time = %lg CR_SU__PC_MIN__TES_EMPTY__AUX_OFF method calculated a timestep"
                                "that was longer than the baseline timestep. Controller moved to the next timestep in the"
                                "controller hierarchy",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                    ...
                    if (step_cr >
                        time_tes_dc) {    // If the time required for CR startup is longer than time to discharge thermal storage at PC MIN
                        ...
                        if (time_tes_dc < mc_kernel.mc_sim_info.ms_ts.m_step - step_tolerance) {
                            ...
                            if (mc_cr_out_solver.m_q_startup ==
                               ...
                               step_cr) {    // If the time required to discharge TES at PC MIN is longer than CR startup
                    ...
                    } else if (time_tes_dc == step_cr)        // Guess both times could be equal
                    {
                        ...
                        error_msg = util::format(
                                "At time = %lg CR_SU__PC_MIN__TES_EMPTY__AUX_OFF method calculated a NaN timestep",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                ...
                case CR_ON__PC_SB__TES_DC__AUX_OFF: {
                    ...
                    if (q_pc_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(q_pc_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_SB__TES_DC__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, q_pc_exit_tolerance);
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                ...
                case CR_SU__PC_TARGET__TES_DC__AUX_OFF: {
                    ...
                    if (q_pc_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(q_pc_exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance
                            ...
                            if (operating_mode == CR_OFF__PC_TARGET__TES_DC__AUX_OFF) {
                                error_msg = util::format(
                                        "At time = %lg CR_OFF__PC_TARGET__TES_DC__AUX_OFF method only reached a convergence"
                                        "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, q_pc_exit_tolerance);
                            } else if (operating_mode == CR_SU__PC_TARGET__TES_DC__AUX_OFF) {
                                error_msg = util::format(
                                        "At time = %lg CR_SU__PC_TARGET__TES_DC__AUX_OFF method only reached a convergence"
                                        "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                        mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, q_pc_exit_tolerance);
                            }
                            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
                    ...
                    if (T_cold_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_cold_exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance
                ...
                case CR_ON__PC_RM_HI__TES_FULL__AUX_OFF: {
                    ...
                    if (mc_pc_out_solver.m_q_dot_htf < q_pc_target) {
                        error_msg = util::format(
                                "At time = %lg CR_ON__PC_RM_HI__TES_FULL__AUX_OFF method converged to a power cycle"
                    ...
                    if (T_rec_in_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_rec_in_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_RM_HI__TES_FULL__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, T_rec_in_exit_tolerance);
                ...
                case CR_ON__PC_MIN__TES_EMPTY__AUX_OFF: {
                    ...
                    double time_empty_guess_ini = fmin(mc_kernel.mc_sim_info.ms_ts.m_step, fmax(0.0,
                                                                                                mc_kernel.mc_sim_info.ms_ts.m_step *
                                                                                                ((q_dot_tes_dc +
                                                                                                  q_dot_cr_on) /
                                                                                                 q_pc_min)));
                    ...
                    while (fabs(diff_q_dot) > tol || diff_q_dot != diff_q_dot) {
                        ...
                        if (iter_q_dot > 1) {
                            if (diff_q_dot !=
                                diff_q_dot) {    // Models did not solve such that a convergence error could be calculated
                            ...
                            {    // Time guess is too small
                                ...
                                if (is_time_upper_bound && is_time_upper_error) {
                                    time_empty_guess = y_time_empty_upper / (y_time_empty_upper - y_time_empty_lower) *
                        ...
                        temp_sim_info.ms_ts.m_time =
                                mc_kernel.mc_sim_info.ms_ts.m_time - mc_kernel.mc_sim_info.ms_ts.m_step +
                                time_empty_guess;    //[s]
                        ...
                        double diff_T_cold =
                                999.9 * tol_T_cold;            // (T_rec_in_calc - T_rec_in_guess)/T_rec_in_guess
                        ...
                        while (fabs(diff_T_cold) > tol_T_cold || diff_T_cold != diff_T_cold) {
                            ...
                            if (diff_T_bounds / T_cold_upper < tol / 2.0) {
                                if (diff_T_cold !=
                                    diff_T_cold) {    // Models aren't producing power or are returning errors, and it appears we've tried the solution space for T_rec_in
                            ...
                            // Subsequent iterations need to re-calculate T_in
                            if (iter_T_cold > 1) {    // diff_T_rec_in = (T_rec_in_calc - T_rec_in_guess)/T_rec_in_guess

                                if (diff_T_cold !=
                                    diff_T_cold) {    // Models did not solve such that a convergence error could be calculated
                                    // However, we can check whether upper and lower bounds are set, and may be able to calculate a new guess via bisection method
                                    // But, check that bounds exist
                                    if (!is_lower_bound || !is_upper_bound) {
                                        T_cold_exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                                ...
                                } else if (diff_T_cold > 0.0)        // Guess receiver inlet temperature was too low
                                {
                                    ...
                                    if (is_upper_bound && is_upper_error) {
                                        T_cold_guess = y_T_cold_upper / (y_T_cold_upper - y_T_cold_lower) *
                                                       (T_cold_lower - T_cold_upper) + T_cold_upper;        //[C]
                                    } else if (is_upper_bound) {
                                        T_cold_guess = 0.5 * (T_cold_lower + T_cold_upper);        //[C]
                                    } else {
                                        T_cold_guess += 2.5;            //[C]
                            ...
                            if (mc_cr_out_solver.m_m_dot_salt_tot == 0.0 || mc_cr_out_solver.m_q_thermal == 0.0) {
                                ...
                                if (iter_T_cold == 1) {
                                    ...
                                    // Also, assume that if both upper and lower bounds exist, then can't generate a new guess because don't know which way to move
                                    if (T_cold_guess <
                                        T_cold_guess_ini) {    // If current guess value is less than the initial guess value, then:
                            ...
                            double T_tes_htf_hot, m_dot_tes_dc;
                            mc_tes.discharge_full(temp_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                                                  T_cold_guess + 273.15, T_tes_htf_hot, m_dot_tes_dc, mc_tes_outputs);
                            T_tes_htf_hot -= 273.15;    //[C] convert from K
                            m_dot_tes_dc *= 3600.0;        //[kg/hr] convert from kg/s
                    ...
                    if (q_pc_exit_mode == OVER_TARGET_PC) {
                        error_msg = util::format(
                                "At time = %lg CR_ON__PC_MIN__TES_EMPTY__AUX_OFF method converged to a power cycle"
                                " thermal input greater than the target.",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                        mc_csp_messages.add_message(C_csp_messages::NOTICE, error_msg);
                    ...
                    if (T_cold_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_cold_exit_tolerance) > relaxed_tol) {    // Did not converge within Relaxed Tolerance
                            ...
                            T_cold_exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                        } else {    // Converge within Relaxed Tolerance, *Report message* but assume timestep solved in this mode

                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_MIN__TES_EMPTY__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, T_cold_exit_tolerance);
                ...
                case CR_DF__PC_MAX__TES_FULL__AUX_OFF: {
                    ...
                    double defocus_guess_ini = fmin(1.0, (m_dot_htf_tes_max_est + m_dot_pc_max_est) /
                    ...
                    while (fabs(diff_q_dot) > tol || diff_q_dot != diff_q_dot) {
                        ...
                        if (diff_defocus_bounds / defocus_upper < tol / 2.0) {
                            if (diff_q_dot !=
                                diff_q_dot) {    // System models not converging, so need to shut them down

                                defocus_exit_tolerance = std::numeric_limits<double>::quiet_NaN();
                                defocus_exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                                break;        // Get out of while()
                            } else if (1.0 - defocus_lower < tol /
                                                             2.0) {    // Full CR output is not fully charging storage and operating PC at max
                        ...
                        if (iter_defocus > 1) {
                            ...
                            } else if (diff_q_dot > 0.0)        // q_dot was too high, decrease defocus
                            {
                                ...
                                if (is_defocus_lower_bound && is_defocus_lower_error)    // False-position method
                                {
                                    defocus_guess = y_defocus_upper / (y_defocus_upper - y_defocus_lower) *
                                                    (defocus_lower - defocus_upper) + defocus_upper;
                                } else if (is_defocus_lower_bound) {
                                    defocus_guess = 0.5 * (defocus_upper + defocus_lower);
                                } else {
                    ...
                    if (defocus_exit_mode == UNDER_TARGET_PC) {
                        error_msg = util::format(
                                "At time = %lg CR_DF__PC_MAX__TES_FULL__AUX_OFF method converged to a power cycle"
                                " thermal input less than the target.",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                        mc_csp_messages.add_message(C_csp_messages::NOTICE, error_msg);
                    ...
                    if (T_rec_in_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_rec_in_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_DF__PC_MAX__TES_FULL__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, T_rec_in_exit_tolerance);
                ...
                case CR_ON__PC_SB__TES_FULL__AUX_OFF: {
                    ...
                    if (T_rec_in_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_rec_in_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_SB__TES_FULL__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, T_rec_in_exit_tolerance);
                ...
                case CR_SU__PC_SU__TES_DC__AUX_OFF: {
                    ...
                    if (step_cr >
                        step_pc_su) {    // If the time required for CR startup is longer than the time to startup the PC
                        ...
                        error_msg = util::format(
                                "At time = %lg CR_SU__PC_SU__TES_DC__AUX_OFF method calculated a NaN timestep",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                ...
                case CR_ON__PC_SU__TES_CH__AUX_OFF: {
                    ...
                    while (fabs(diff_T_rec_in) > tol || diff_T_rec_in != diff_T_rec_in) {
                        ...
                        bool ch_solved = mc_tes.charge(step_pc_su, mc_weather.ms_outputs.m_tdry + 273.15,
                        ...
                        double T_rec_in_calc =
                                (m_dot_tes_ch * T_tes_cold_out + m_dot_pc * mc_pc_out_solver.m_T_htf_cold) /
                                mc_cr_out_solver.m_m_dot_salt_tot;
                    ...
                    if (T_rec_in_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_rec_in_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_ON__PC_SU__TES_CH__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, T_rec_in_exit_tolerance);
                ...
                case CR_DF__PC_SU__TES_FULL__AUX_OFF: {
                    ...
                    while (true) {
                        ...
                        T_htf_cold_code = 0;
                        try {
                            T_htf_cold_code = c_solver.solve(xy_pair_1, xy_pair_2, 0.0, T_htf_cold_solved, tol_solved,
                                                             iter_solved);
                        }
                        catch (C_csp_exception) {
                            throw (C_csp_exception(
                                    "CR_DF__PC_SU__TES_CH__AUX_OFF solver (no defocus guess) to converge the HTF cold temperature returned an unexpected exemption"));
                        }

                        if (T_htf_cold_code != C_monotonic_eq_solver::CONVERGED) {
                            if (T_htf_cold_code > C_monotonic_eq_solver::CONVERGED && fabs(tol_solved) <= 0.1) {
                                error_msg = util::format(
                                        "At time = %lg the iteration to find the cold HTF temperature connecting the receiver, power cycle startup, and tes charge only reached a convergence "
                                        "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                    ...
                    while (fabs(diff_m_dot) > tol || diff_m_dot != diff_m_dot) {
                        ...
                        if (diff_defocus_bounds / defocus_upper < tol / 2.0) {
                            if (diff_m_dot !=
                                diff_m_dot) {    // System models not converging, so need to shut them down
                        ...
                        while (fabs(diff_T_rec_in) > tol || diff_T_rec_in != diff_T_rec_in) {
                            ...
                            // Calculate mass flow remaining to charge storage
                            m_dot_tes_ch_balance =
                                    mc_cr_out_solver.m_m_dot_salt_tot - mc_pc_inputs.m_m_dot;    //[kg/hr]

                            // Solve TES for FULL charge
                            double T_htf_tes_out;
                            T_htf_tes_out = m_dot_htf_tes_out = std::numeric_limits<double>::quiet_NaN();
                            mc_tes.charge_full(step_pc_su, mc_weather.ms_outputs.m_tdry + 273.15,
                                               T_htf_rec_out + 273.15,
                                               T_htf_tes_out, m_dot_htf_tes_out, mc_tes_outputs);
                            ...
                            double T_rec_in_calc =
                                    (m_dot_tes_ch_balance * T_htf_tes_out + m_dot_pc * T_pc_out) / m_dot_receiver;
                    ...
                    if (defocus_exit_mode == UNDER_TARGET_PC) {
                        error_msg = util::format(
                                "At time = %lg CR_DF__PC_SU__TES_FULL__AUX_OFF method converged to a power cycle"
                                " thermal input less than the target.",
                                mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0);
                        mc_csp_messages.add_message(C_csp_messages::NOTICE, error_msg);
                    ...
                    if (T_rec_in_exit_mode == POOR_CONVERGENCE) {
                        if (fabs(T_rec_in_exit_tolerance) >
                            ...
                            error_msg = util::format(
                                    "At time = %lg CR_DF__PC_SU__TES_FULL__AUX_OFF method only reached a convergence"
                                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, T_rec_in_exit_tolerance);
        ...
        */
        ...
        double W_dot_bop = m_cycle_W_dot_des * ms_system_params.m_bop_par * ms_system_params.m_bop_par_f *
                           (ms_system_params.m_bop_par_0 + ms_system_params.m_bop_par_1 * W_dot_ratio +
        ...
        disp_qsf_last = mc_cr_out_solver.m_q_startup > 0. ? mc_cr_out_solver.m_q_thermal
        ...
        if (m_is_tes) {
            ...
            mc_tes.discharge_avail_est(m_T_htf_cold_des, mc_kernel.mc_sim_info.ms_ts.m_step, e_tes_disch, mdot_disch,
                                       Tdisch);
        ...
        mc_reported_outputs.value(C_solver_outputs::TDRY,
                                  mc_weather.ms_outputs.m_tdry);        //[C] Dry bulb temperature
        mc_reported_outputs.value(C_solver_outputs::TWET,
                                  mc_weather.ms_outputs.m_twet);        //[C] Wet bulb temperature
        mc_reported_outputs.value(C_solver_outputs::RH,
        ...
        mc_reported_outputs.value(C_solver_outputs::TES_Q_DOT_LOSS,
                                  mc_tes_outputs.m_q_dot_loss);       //[MWt] TES thermal power losses to environment
        mc_reported_outputs.value(C_solver_outputs::TES_W_DOT_HEATER,
                                  mc_tes_outputs.m_q_heater);       //[MWe] Energy into TES from heaters (hot+cold) to maintain tank temperatures
        mc_reported_outputs.value(C_solver_outputs::TES_T_HOT, mc_tes_outputs.m_T_hot_final -
                                                               273.15);    //[C] TES hot temperature at end of timestep
        mc_reported_outputs.value(C_solver_outputs::TES_T_COLD, mc_tes_outputs.m_T_cold_final -
                                                                273.15);  //[C] TES cold temperature at end of timestep
        mc_reported_outputs.value(C_solver_outputs::TES_Q_DOT_DC,
                                  mc_tes_outputs.m_q_dot_dc_to_htf);    //[MWt] TES discharge thermal power
        mc_reported_outputs.value(C_solver_outputs::TES_Q_DOT_CH,
        ...
        mc_reported_outputs.value(C_solver_outputs::TES_M_DOT_DC,
                                  mc_tes_dc_htf_state.m_m_dot);         //[kg/hr] TES mass flow rate discharge
        mc_reported_outputs.value(C_solver_outputs::TES_M_DOT_CH,
                                  mc_tes_ch_htf_state.m_m_dot);         //[kg/hr] TES mass flow rate charge
        // Parasitics outputs
        mc_reported_outputs.value(C_solver_outputs::COL_W_DOT_TRACK,
                                  mc_cr_out_solver.m_W_dot_col_tracking);    //[MWe] Collector tracking, startup, stow power consumption
        mc_reported_outputs.value(C_solver_outputs::CR_W_DOT_PUMP,
                                  mc_cr_out_solver.m_W_dot_htf_pump);          //[MWe] Receiver/tower HTF pumping power
        mc_reported_outputs.value(C_solver_outputs::SYS_W_DOT_PUMP, (mc_pc_out_solver.m_W_dot_htf_pump +
                                                                     mc_tes_outputs.m_W_dot_rhtf_pump));    //[MWe] TES & PC HTF pumping power (Receiver - PC side HTF)
        mc_reported_outputs.value(C_solver_outputs::PC_W_DOT_COOLING,
                                  mc_pc_out_solver.m_W_cool_par);           //[MWe] Power cycle cooling power consumption (fan, pumps, etc.)
        mc_reported_outputs.value(C_solver_outputs::SYS_W_DOT_FIXED,
                                  W_dot_fixed);                                //[MWe] Fixed electric parasitic power load
        mc_reported_outputs.value(C_solver_outputs::SYS_W_DOT_BOP,
                                  W_dot_bop);                                    //[MWe] Balance-of-plant electric parasitic power load
        mc_reported_outputs.value(C_solver_outputs::W_DOT_NET,
        ...
        do {
            if (mc_kernel.mc_sim_info.ms_ts.m_time >= m_report_time_end) {
                ...
                mc_reported_outputs.overwrite_most_recent_timestep(C_solver_outputs::TIME_FINAL,
                                                                   m_report_time_end / 3600.0);    //[hr]
        ...
        if (mc_kernel.mc_sim_info.ms_ts.m_time < mc_kernel.get_baseline_end_time()) {
            ...
            mc_kernel.mc_sim_info.ms_ts.m_step =
                    mc_kernel.mc_sim_info.ms_ts.m_time - mc_kernel.mc_sim_info.ms_ts.m_time_start;    //[s]
            ...
            if (mc_kernel.get_baseline_end_time() == mc_kernel.get_wf_end_time()) {
                ...
                throw (C_csp_exception(
                        "Baseline end time is larger than the weather file end time. This shouldn't happen"));
            }
...
void C_csp_solver::solver_pc_su_controlled__tes_dc(double step_tol /*s*/,
    ...
    c_solver.settings(1.E-3, 50, std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(),
                      false);
    ...
    try {
        ...
        throw (C_csp_exception(
                "solver_pc_su_controlled__tes_dc received an exception from the monotonic equation solver"));
    }
    ...
    if (solver_code != C_monotonic_eq_solver::CONVERGED) {
        if (solver_code > C_monotonic_eq_solver::CONVERGED && abs(tol_solved) <= 0.1) {
            error_msg = util::format(
                    "At time = %lg the iteration to find the hot HTF temperature connecting the power cycle startup and tes discharge only reached a convergence "
                    "= %lg. Check that results at this timestep are not unreasonably biasing total simulation results",
                    mc_kernel.mc_sim_info.ms_ts.m_time / 3600.0, tol_solved);
            mc_csp_messages.add_message(C_csp_messages::WARNING, error_msg);
        } else {
    ...
    if (exit_mode == C_csp_solver::CSP_NO_SOLUTION) {    // Try fully discharging TES and beginning PC startup
        ...
        mc_tes.discharge_full(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                              m_T_htf_cold_des, T_pc_in_calc, m_dot_pc, mc_tes_outputs);
        ...
        if (time_pc_su < mc_kernel.mc_sim_info.ms_ts.m_step -
                         step_tol) {    // We fully discharged the TES, so need full timestep here
            exit_mode = C_csp_solver::CSP_NO_SOLUTION;
...
void C_csp_solver::solver_cr_on__pc_float__tes_full(int power_cycle_mode,
    ...
    while (fabs(diff_T_rec_in) > tol || diff_T_rec_in != diff_T_rec_in) {
        ...
        if (!mc_pc_out_solver.m_was_method_successful && mc_pc_inputs.m_standby_control == C_csp_power_cycle::ON) {
            ...
            } else {    // If power cycle model has solved with results previously, then try to find another guess value
...
void C_csp_solver::solver_pc_on_fixed__tes_dc(double q_dot_pc_fixed /*MWt*/, int power_cycle_mode,
    ...
    while (fabs(diff_T_cold) > tol || diff_T_cold != diff_T_cold) {
        ...
        if (iter_T_cold > 1) {    // diff_T_cold = (T_cold_calc - T_cold_guess)/T_cold_guess
            ...
            } else if (diff_T_cold > 0.0)        // Guess receiver inlet temperature was too low
            {
                ...
                if (is_upper_bound && is_upper_error) {
                    T_cold_guess = y_T_cold_upper / (y_T_cold_upper - y_T_cold_lower) * (T_cold_lower - T_cold_upper) +
                                   T_cold_upper;        //[C]
                } else if (is_upper_bound) {
                    T_cold_guess = 0.5 * (T_cold_lower + T_cold_upper);        //[C]
                } else {
        ...
        mc_tes.discharge_avail_est(T_cold_guess + 273.15, mc_kernel.mc_sim_info.ms_ts.m_step, q_dot_tes_dc_local,
                                   m_dot_tes_dc_max, T_tes_hot_return);
        ...
        double m_dot_pc_guess = fmin(m_dot_pc_max,
                                     fmax(m_dot_pc_min, m_m_dot_pc_des * q_dot_pc_fixed / m_cycle_q_dot_des));
        ...
        double diff_q_pc = 999.9 *
                           tol;    //[-] (Calc - Target)/Target: (+) Mass flow rate guess too high, (-) Mass flow rate guess too low
        int iter_q_pc = 0;                //[-]
        ...
        while (fabs(diff_q_pc) > tol_q_pc || diff_q_pc != diff_q_pc) {
            ...
            if (diff_q_pc_bounds / m_dot_pc_upper < tol_q_pc / 2.0) {
                if (diff_q_pc !=
                    diff_q_pc) {    // Models aren't producing power or are returning errors, and it appears we've tried the solution space for m_dot_pc

                    q_pc_exit_mode = C_csp_solver::CSP_NO_SOLUTION;
                    q_pc_exit_tolerance = std::numeric_limits<double>::quiet_NaN();
                    break;    // exits while() on diff_q_pc and sends control to while() on diff_T_rec_in
                } else if ((m_dot_pc_max - m_dot_pc_guess) / m_dot_pc_max <
                           tol_q_pc) {    // Have tried maximum mass flow rate and can't achieve target power

                    q_pc_exit_mode = UNDER_TARGET_PC;
                    q_pc_exit_tolerance = std::numeric_limits<double>::quiet_NaN();
                    break;    // exits while() on diff_q_pc and sends control to while() on diff_T_rec_in
                } else if ((m_dot_pc_guess - m_dot_pc_min) / m_dot_pc_max <
                           tol_q_pc) {    // At minimum mass flow rate, we're still overshooting target power

                    q_pc_exit_mode = OVER_TARGET_PC;
                    q_pc_exit_tolerance = std::numeric_limits<double>::quiet_NaN();
                    break;    // exits while() on diff_q_pc and sends control to while() on diff_T_rec_in
                } else {    // At minimum mass flow rate, we're still overshooting target power
            ...
            if (iter_q_pc > 1) {
                if (diff_q_pc !=
                    diff_q_pc) {    // Models did not solve such that a convergence error could be calculated
                    // However, if upper and lower bounds are set, then we can calculate a new guess via bisection method
                    // First, need to check that bounds exist
                ...
                } else if (diff_q_pc < 0.0)            // Mass flow rate guess was too low
                {
                    ...
                    {
                        m_dot_pc_guess = y_m_dot_pc_upper / (y_m_dot_pc_upper - y_m_dot_pc_lower) *
                                         (m_dot_pc_lower - m_dot_pc_upper) + m_dot_pc_upper;    //[kg/hr]
            ...
            bool tes_success = mc_tes.discharge(mc_kernel.mc_sim_info.ms_ts.m_step,
            ...
            if (!mc_pc_out_solver.m_was_method_successful && mc_pc_inputs.m_standby_control == C_csp_power_cycle::ON) {
                ...
                if (iter_q_pc == 1) {
                    ...
                    q_pc_exit_tolerance = std::numeric_limits<double>::quiet_NaN();
                    break;        // exits while() on diff_q_pc and sends control to while() on diff_T_rec_in
                } else {    // If power cycle model has solved with results previously, then try to find another guess
                    // Assumption here is that power cycle solved at the first guess mass flow rate
                    // Also, assume that if both upper and lower bounds exist, then can't generate a new guess

                    if (m_dot_pc_guess <
                        m_dot_pc_guess_ini) {    // If current guess value is less than initial value, then:
            ...
            diff_q_pc = (mc_pc_out_solver.m_q_dot_htf - q_dot_pc_fixed) /
                        q_dot_pc_fixed;        //[-] (Calc-Target)/Target: (+) Mass flow rate guess too high, (-) Mass flow rate guess too low
...
void C_csp_solver::solver_pc_fixed__tes_empty(double q_dot_pc_fixed /*MWt*/,
    ...
    while (fabs(diff_T_tes_cold) > tol || diff_T_tes_cold != diff_T_tes_cold) {
        ...
        if (diff_T_bounds / T_tes_cold_upper < tol / 2.0) {
            if (diff_T_tes_cold !=
                diff_T_tes_cold) {    // Models aren't producing power or are return errors, and it appears we've tried the solution space for T_tes_cold
        ...
        // Subsequent iterations need to re-calculate T_tes_cold
        if (iter_T_tes_cold > 1) {    // diff_T_tes_cold = (T_tes_cold_calc - T_tes_cold_guess)/T_tes_cold_guess
            ...
            } else if (diff_T_tes_cold > 0.0)        // Guess cold temperature was too low
            {
                ...
                if (is_upper_bound && is_upper_error) {
                    T_tes_cold_guess = y_T_tes_cold_upper / (y_T_tes_cold_upper - y_T_tes_cold_lower) *
                                       (T_tes_cold_lower - T_tes_cold_upper) + T_tes_cold_upper;        //[C]
                } else if (is_upper_bound) {
                    T_tes_cold_guess = 0.5 * (T_tes_cold_lower + T_tes_cold_upper);
                } else {
                    T_tes_cold_guess += 2.5;            //[C]
        ...
        T_htf_hot_out = m_dot_htf_max = std::numeric_limits<double>::quiet_NaN();
        mc_tes.discharge_full(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                              T_tes_cold_guess + 273.15, T_htf_hot_out, m_dot_htf_max, mc_tes_outputs);
        ...
        double time_empty_ini =
                mc_kernel.mc_sim_info.ms_ts.m_step * (mc_tes_outputs.m_q_dot_dc_to_htf / q_dot_pc_fixed);        //[s]
        ...
        while (fabs(diff_q_dot) > tol_q_dot || diff_q_dot != diff_q_dot) {
            ...
            if (iter_q_dot > 1) {
                ...
                {    // Time guess is too small
                    ...
                    if (is_time_upper_bound && is_time_upper_error) {
                        time_tes_dc = y_time_empty_upper / (y_time_empty_upper - y_time_empty_lower) *
                                      (time_empty_lower - time_empty_upper) + time_empty_upper;        //[kg/hr]
                    } else if (is_time_upper_bound) {
                        time_tes_dc = 0.5 * (time_empty_lower + time_empty_upper);
                    } else {
            ...
            T_htf_tes_hot = m_dot_tes_dc = std::numeric_limits<double>::quiet_NaN();
            mc_tes.discharge_full(time_tes_dc, mc_weather.ms_outputs.m_tdry + 273.15, T_tes_cold_guess + 273.15,
                                  T_htf_tes_hot, m_dot_tes_dc, mc_tes_outputs);
        ...
        temp_sim_info.ms_ts.m_time =
                mc_kernel.mc_sim_info.ms_ts.m_time - mc_kernel.mc_sim_info.ms_ts.m_step + time_tes_dc;    //[s]
    ...
    while (fabs(diff_T_rec_in) > tol || diff_T_rec_in != diff_T_rec_in) {
        ...
        if (iter_T_rec_in > 1) {    // diff_T_rec_in = (T_rec_in_calc - T_rec_in_guess)/T_rec_in_guess
            ...
            } else if (diff_T_rec_in > 0.0)        // Guess receiver inlet temperature was too low
            {
                ...
                if (is_upper_bound && is_upper_error) {
                    T_rec_in_guess =
                            y_rec_in_upper / (y_rec_in_upper - y_rec_in_lower) * (T_rec_in_lower - T_rec_in_upper) +
                            T_rec_in_upper;        //[C]
                } else if (is_upper_bound) {
                    T_rec_in_guess = 0.5 * (T_rec_in_lower + T_rec_in_upper);        //[C]
                } else {
        ...
        double q_dot_tes_dc_local, m_dot_tes_dc_max, T_tes_hot_return;
        q_dot_tes_dc_local = m_dot_tes_dc_max = T_tes_hot_return = std::numeric_limits<double>::quiet_NaN();
        mc_tes.discharge_avail_est(T_rec_in_guess + 273.15, mc_kernel.mc_sim_info.ms_ts.m_step, q_dot_tes_dc_local,
                                   m_dot_tes_dc_max, T_tes_hot_return);
        m_dot_tes_dc_max *= 3600.0;        //[kg/hr] convert from kg/s
        ...
        //		goal to not send the power cycle a ridiculously large mass flow rate
        //		which could be possible if we choose to dispatch a lot of TES
        double m_dot_pc_max = fmin(m_dot_receiver + m_dot_tes_dc_max,
        ...
        while (fabs(diff_q_pc) > tol_q_pc || diff_q_pc != diff_q_pc) {
            ...
            // Enthalpy balance (mixer)
            double T_pc_htf_in = (m_dot_tes_dc * T_htf_hot_out + m_dot_receiver * mc_cr_out_solver.m_T_salt_hot) /
                                 (m_dot_pc_guess);    //[C]
...
void C_csp_solver::solver_cr_on__pc_fixed__tes_ch(double q_dot_pc_fixed /*MWt*/, int power_cycle_mode,
    ...
    while (fabs(diff_T_rec_in) > tol || diff_T_rec_in != diff_T_rec_in) {
        ...
        mc_tes.charge_avail_est(mc_cr_out_solver.m_T_salt_hot + 273.15, mc_kernel.mc_sim_info.ms_ts.m_step,
        ...
        double m_dot_pc_guess = fmin(m_dot_pc_max,
                                     fmin(m_dot_receiver, m_m_dot_pc_des * q_dot_pc_fixed / m_cycle_q_dot_des));
        double m_dot_pc_guess_ini = m_dot_pc_guess;
        ...
        double T_tes_cold_out = std::numeric_limits<double>::quiet_NaN();
        bool tes_success = mc_tes.charge(mc_kernel.mc_sim_info.ms_ts.m_step, mc_weather.ms_outputs.m_tdry + 273.15,
                                         m_dot_tes / 3600.0, mc_cr_out_solver.m_T_salt_hot + 273.15,
                                         T_tes_cold_out, mc_tes_outputs);
        ...
        double T_rec_in_calc =
                (m_dot_tes * T_tes_cold_out + m_dot_pc_guess * T_pc_out) / m_dot_receiver - 273.15;        //[C]
...
void C_csp_solver::solver_cr_to_pc_to_cr(int pc_mode, double field_control_in, double tol, int &exit_mode,
    ...
    c_solver.settings(tol, 50, std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(),
                      false);
    ...
    int solver_code = 0;
    try {
        solver_code = c_solver.solve(T_htf_cold_guess_colder, T_htf_cold_guess_warmer, 0.0, T_htf_cold_solved,
                                     tol_solved, iter_solved);
    }
    catch (C_csp_exception) {
...
void C_csp_tou::init_parent() {
    ...
    if (mc_dispatch_params.m_dispatch_optimize && mc_dispatch_params.m_is_block_dispatch) {
        throw (C_csp_exception("Both plant control strategies were selected. Please select one.",
                               "TOU initialization"));
    }

...
double C_pc_gen::get_efficiency_at_TPH(double T_degC, double P_atm, double relhum_pct)
{
	...
	const C_csp_solver_sim_info &sim_info)
{
	...
	for( int i = 0; i < ms_params.mv_etaQ_coefs.size(); i++ )
...
void C_pc_gen::assign(int index, float *p_reporting_ts_array, int n_reporting_ts_array)
{

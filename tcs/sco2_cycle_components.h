...
void calculate_turbomachinery_outlet_1(double T_in /*K*/, double P_in /*kPa*/, double P_out /*kPa*/,
                                       ...
                                       double &enth_in /*kJ/kg*/, double &entr_in /*kJ/kg-K*/,
                                       double &dens_in /*kg/m3*/, double &temp_out /*K*/,
                                       double &enth_out /*kJ/kg*/, double &entr_out /*kJ/kg-K*/,
                                       double &dens_out /*kg/m3*/, double &spec_work /*kJ/kg*/);

void calculate_turbomachinery_outlet_1(double T_in /*K*/, double P_in /*kPa*/, double P_out /*kPa*/,
                                       double eta_isen /*-*/, bool is_comp, int &error_code,
                                       double &spec_work /*kJ/kg*/);

void isen_eta_from_poly_eta(double T_in /*K*/, double P_in /*kPa*/, double P_out /*kPa*/, double poly_eta /*-*/,
                            bool is_comp, int &error_code, double &isen_eta);

int calc_turbomachinery_eta_isen(double T_in /*K*/, double P_in /*kPa*/,
                                 double T_out /*K*/, double P_out /*kPa*/, double &eta_isen);

int
Ts_data_over_linear_dP_ds(double P_in /*kPa*/, double s_in /*kJ/kg-K*/, double P_out /*kPa*/, double s_out /*kJ/kg-K*/,
                          std::vector<double> &T_data /*C*/, std::vector<double> &s_data /*kJ/kg-K*/,
                          int N_points = 30);
...
public:
    ...
    void
    off_design_turbine(double T_in, double P_in, double P_out, double N, int &error_code, double &m_dot, double &T_out);
...
public:
    ...
    int design_given_shaft_speed(double T_in /*K*/, double P_in /*kPa*/, double m_dot /*kg/s*/,
                                 double N_rpm /*rpm*/, double eta_isen /*-*/, double &P_out /*kPa*/,
                                 double &T_out /*K*/, double &tip_ratio /*-*/);
    ...
    virtual double
    calc_psi_isen(double phi /*-*/, double N_des_over_N_od /*-*/, double T_comp_in /*K*/, double P_comp_in /*kPa*/) = 0;

    virtual double calc_eta_normalized(double phi /*-*/, double N_des_over_N_od /*-*/, double T_comp_in /*K*/,
                                       double P_comp_in /*kPa*/) = 0;
};
...
public:
    ...
    virtual double
    calc_psi_isen(double phi /*-*/, double N_des_over_N_od /*-*/, double T_comp_in /*K*/, double P_comp_in /*kPa*/);

    virtual double calc_eta_normalized(double phi /*-*/, double N_des_over_N_od /*-*/, double T_comp_in /*K*/,
                                       double P_comp_in /*kPa*/);
};

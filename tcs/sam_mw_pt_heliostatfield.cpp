        ...
        switch (run_type) {
            ...
            case sam_mw_pt_heliostatfield::RUN_TYPE::USER_FIELD: {
                ...
                helios.front().active_fraction =
                        helio_active_fraction * dens_mirror;   //availability * mirror area fraction
                ...
                if (run_type == sam_mw_pt_heliostatfield::RUN_TYPE::AUTO) {
                    ...
                    */
                    ...
                    for (int i = 0; i < 8760; i++) {
                        if (!wFile.read(&wf)) {
                            string msg = "solarpilot: could not read data line " + util::to_string(i + 1) +
                    ...
                    for (int i = 0; i < N_hel; i++) {
                        ...
                        if (pos_dim == 3)
                            TCS_MATRIX_INDEX(var(P_helio_positions), i, 2) = layout.heliostat_positions.at(
                                    i).location.z;
                    }
                    ...
                    */
                    ...
                    for (int i = 0; i < N_hel; i++) {
                        ...
                        if (pos_dim == 3)
                            layout.heliostat_positions.at(i).location.z = TCS_MATRIX_INDEX(var(P_helio_positions), i,
                                                                                           2);

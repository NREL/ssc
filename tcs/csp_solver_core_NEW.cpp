            ...
            switch (operating_mode) {
                ...
                case CR_DF__PC_SU__TES_FULL__AUX_OFF: {
                    ...
                    if ((q_dot_pc_defocus - q_pc_max) / q_pc_max > 1.E-3) {
                        if (operating_mode == CR_DF__PC_SU__TES_FULL__AUX_OFF) {
                            throw (C_csp_exception(util::format(
                                    "At time = %lg, %s should not need to defocus to meet thermal power requirements"
                                    " because STARTUP_CONTROLLED should choose a mass flow rate that satisfies thermal power limits",

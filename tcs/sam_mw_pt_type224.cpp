...
public:
    ...
    virtual int init() {
        ...
        */
        ...
        tech_type = (int) value(
                P_TECH_TYPE);        //Flag indicating which coef. set to use. (1=tower,2=trough,3=user) [none]
...
TCS_IMPLEMENT_TYPE(sam_mw_pt_type224, "Indirect HTF power cycle model", "Mike Wagner", 1, sam_mw_pt_type224_variables,
                   NULL, 1);

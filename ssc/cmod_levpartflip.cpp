...
/* Dispatch */
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch1",	"Energy produced by the system in dispatch period 1",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch2",	"Energy produced by the system in dispatch period 2",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch3",	"Energy produced by the system in dispatch period 3",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch4",	"Energy produced by the system in dispatch period 4",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch5",	"Energy produced by the system in dispatch period 5",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch6",	"Energy produced by the system in dispatch period 6",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch7",	"Energy produced by the system in dispatch period 7",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch8",	"Energy produced by the system in dispatch period 8",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_dispatch9",	"Energy produced by the system in dispatch period 9",	"kWh",   "",	"Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch1",                "First year energy from the system in dispatch period 1",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch2",                "First year energy from the system in dispatch period 2",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch3",                "First year energy from the system in dispatch period 3",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch4",                "First year energy from the system in dispatch period 4",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch5",                "First year energy from the system in dispatch period 5",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch6",                "First year energy from the system in dispatch period 6",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch7",                "First year energy from the system in dispatch period 7",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch8",                "First year energy from the system in dispatch period 8",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_dispatch9",                "First year energy from the system in dispatch period 9",      "kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },

	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price1",                "First year energy price dispatch period 1",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price2",                "First year energy price dispatch period 2",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price3",                "First year energy price dispatch period 3",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price4",                "First year energy price dispatch period 4",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price5",                "First year energy price dispatch period 5",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price6",                "First year energy price dispatch period 6",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price7",                "First year energy price dispatch period 7",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price8",                "First year energy price dispatch period 8",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,     "firstyear_energy_price9",                "First year energy price dispatch period 9",      "cents/kWh",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
...
//	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear",		"First year energy from the system by month",	"",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD1",		"First year energy from the system by month for TOD1",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD2",		"First year energy from the system by month for TOD2",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD3",		"First year energy from the system by month for TOD3",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD4",		"First year energy from the system by month for TOD4",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD5",		"First year energy from the system by month for TOD5",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD6",		"First year energy from the system by month for TOD6",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD7",		"First year energy from the system by month for TOD7",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD8",		"First year energy from the system by month for TOD8",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "cf_energy_net_monthly_firstyear_TOD9",		"First year energy from the system by month for TOD9",	"kWh",   "", "Cash Flow Revenue",             "*",				   "",                 "" },
...
/* DHF Capital Cost */
	...
	{ SSC_INPUT,        SSC_NUMBER,     "months_working_reserve",		"Working capital reserve months of operating costs of o and m",		"months",	 "",						"Other Capital Costs",             "?=6",					    "INTEGER,MIN=0",      			        "" },

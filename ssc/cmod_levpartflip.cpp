...
//	{ SSC_OUTPUT,        SSC_NUMBER,      "first_year_energy_net",    "Net Annual Energy",  "", "",                      "DHF",      "*",                     "",                "" },
	...
	{ SSC_OUTPUT, SSC_NUMBER, "lppa_real", "Levelized revenue (real)", "", "", "DHF", "*", "", "" },
	{ SSC_OUTPUT, SSC_NUMBER, "lppa_nom", "Levelized revenue (nominal)", "", "", "DHF", "*", "", "" },
...
/*	assign("flip_actual_year", var_data((ssc_number_t) flip_year));
	...
	*/
	...
	// from single_owner.xlsm - adjust for tax investor returns (used for NPV and IRR)
//	cf.at(CF_Annual_Costs, 0) = -issuance_of_equity;
	...
	for (i = 1; i <= nyears; i++)
	{
		...
		tax_investor_preflip_tax_frac : tax_investor_postflip_tax_frac) * (
			...
			); // note sign is negative for positive disbursement
	}

...
//    VARTYPE           DATATYPE          NAME                   LABEL                                                                UNITS           META            GROUP            REQUIRED_IF                CONSTRAINTS              UI_HINTS
        ...
        {SSC_INPUT, SSC_NUMBER, "rec_su_delay", "Fixed startup delay time for the receiver", "hr", "", "receiver", "*",
         "", ""},
        {SSC_INPUT, SSC_NUMBER, "rec_qf_delay", "Energy-based rcvr startup delay (fraction of rated thermal power)", "",
         "", "receiver", "*", "", ""},
        ...
        {SSC_INPUT, SSC_NUMBER, "rec_angle", "Section of the cavity circle covered in panels", "deg", "",
         "cavity_receiver", "*", "", ""},
        ...
        {SSC_INPUT, SSC_NUMBER, "conv_model", "Type of convection model (1=Clausing, 2=Siebers/Kraabel)", "-", "",
         "cavity_receiver", "*", "", ""},
        //{ SSC_INPUT,        SSC_NUMBER,      "m_dot_htf_max",        "Maximum receiver mass flow rate",                                   "kg/hr",        "",            "cavity_receiver","*",                       "",                      "" },
        {SSC_INPUT, SSC_MATRIX, "eps_wavelength", "Matrix containing wavelengths, active & passive surface eps", "-",
         "", "cavity_receiver", "*", "", ""},
        ...
        {SSC_INPUT, SSC_NUMBER, "conv_forced", "1=forced (use wind), 0=natural", "-", "", "cavity_receiver", "*", "",
         ""},
        {SSC_INPUT, SSC_NUMBER, "h_wind_meas", "Height at which wind measurements are given", "m", "",
         "cavity_receiver", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "conv_wind_dir", "Wind direction dependent forced convection 1=on 0=off", "-", "",
         "cavity_receiver", "*", "", ""},
        ...
        {SSC_INPUT, SSC_NUMBER, "pc_config", "0: Steam Rankine (224), 1: sCO2 Recompression (424)", "none", "",
        ...
        {SSC_INPUT, SSC_NUMBER, "deltaT_PHX", "Design temperature difference in PHX", "C", "", "powerblock", "*", "",
         ""},
        {SSC_INPUT, SSC_NUMBER, "fan_power_perc_net", "% of net cycle output used for fan power at design", "%", "",
         "powerblock", "*", "", ""},
        ...
        {SSC_INPUT, SSC_NUMBER, "aux_par_f", "Aux heater, boiler parasitic - multiplying fraction", "none", "",
         "parasitics", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "aux_par_0", "Aux heater, boiler parasitic - constant coefficient", "none", "",
         "parasitics", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "aux_par_1", "Aux heater, boiler parasitic - linear coefficient", "none", "",
         "parasitics", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "aux_par_2", "Aux heater, boiler parasitic - quadratic coefficient", "none", "",
         "parasitics", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "bop_par", "Balance of plant parasitic power fraction", "MWe/MWcap", "", "parasitics",
         "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "bop_par_f", "Balance of plant parasitic power fraction - mult frac", "none", "",
         "parasitics", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "bop_par_0", "Balance of plant parasitic power fraction - const coeff", "none", "",
         "parasitics", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "bop_par_1", "Balance of plant parasitic power fraction - linear coeff", "none", "",
         "parasitics", "*", "", ""},
        {SSC_INPUT, SSC_NUMBER, "bop_par_2", "Balance of plant parasitic power fraction - quadratic coeff", "none", "",
         "parasitics", "*", "", ""},
        ...
        {SSC_OUTPUT, SSC_ARRAY, "Q_thermal", "Receiver thermal power to HTF", "MWt", "", "Outputs", "*", "LENGTH=8760",
         ""},
        {SSC_OUTPUT, SSC_ARRAY, "q_startup", "Receiver startup thermal energy consumed", "MWt-hr", "", "Outputs", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "m_dot_field", "Receiver HTF mass flow rate", "kg/hr", "", "Outputs", "*",
         "LENGTH=8760", ""},
        ...
        {SSC_OUTPUT, SSC_ARRAY, "vol_tank_hot_fin", "TES HTF volume in hot tank", "m3", "", "Type251", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "m_dot_charge_field", "TES HTF mass flow rate (charging)", "kg/hr", "", "Type250", "*",
         "LENGTH=8760", ""},
        ...
        {SSC_OUTPUT, SSC_ARRAY, "q_to_tes", "TES thermal energy into storage", "MWt", "", "Type251", "*", "LENGTH=8760",
         ""},
        {SSC_OUTPUT, SSC_ARRAY, "T_hot_node", "TES [thermocline] temperature - hot node", "C", "", "Outputs", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "T_cold_node", "TES [thermocline] temperature - cold node", "C", "", "Outputs", "*",
         "LENGTH=8760", ""},
        ...
        {SSC_OUTPUT, SSC_ARRAY, "f_hot", "TES [thermocline] Hot depth fraction", "", "", "Outputs", "*", "LENGTH=8760",
         ""},
        {SSC_OUTPUT, SSC_ARRAY, "f_cold", "TES [thermocline] Cold depth fraction", "", "", "Outputs", "*",
         "LENGTH=8760", ""},

        //power block
        {SSC_OUTPUT, SSC_ARRAY, "eta", "Cycle efficiency (gross)", "", "", "Type224", "*", "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "P_out_net", "Cycle electrical power output (net)", "MWe", "", "Net_E_Calc", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "P_cycle", "Cycle electrical power output (gross)", "MWe", "", "Net_E_Calc", "*",
         "LENGTH=8760", ""},
        ...
        {SSC_OUTPUT, SSC_ARRAY, "T_turbine_in", "Cycle turbine inlet temperature", "C", "", "Outputs", "",
         "LENGTH=8760", ""},
        ...
        //parasitics
        {SSC_OUTPUT, SSC_ARRAY, "P_tower_pump", "Parasitic power receiver HTF pump", "MWe", "", "Outputs", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "htf_pump_power", "Parasitic power TES and Cycle HTF pump", "MWe", "", "Outputs", "*",
         "LENGTH=8760", ""},
        ...
        {SSC_OUTPUT, SSC_ARRAY, "P_aux", "Parasitic power auxiliary heater operation", "MWe", "", "Outputs", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "P_cooling_tower_tot", "Parasitic power condenser operation", "MWe", "", "Outputs", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "P_piping_tot", "Parasitic power equiv. header pipe losses", "MWe", "", "Outputs", "*",
         "LENGTH=8760", ""},
        {SSC_OUTPUT, SSC_ARRAY, "P_tank_heater", "Parasitic power TES freeze protection", "MWe", "", "Outputs", "*",
         "LENGTH=8760", ""},
        //{ SSC_OUTPUT,       SSC_ARRAY,       "P_tower_par",          "Parasitic power receiver freeze protection",                     "MWe",          "",            "Outputs",        "*",                       "LENGTH=8760",           "" },
        {SSC_OUTPUT, SSC_ARRAY, "P_parasitics", "Parasitic power total consumption", "MWe", "", "Outputs", "*",
         "LENGTH=8760", ""},
        ...
        */
        ...
        if (is_optimize) {
            ...
            double receiver = as_double("rec_ref_cost") *
                              pow(A_rec / as_double("rec_ref_area"), as_double("rec_cost_exp"));     //receiver cost
            ...
            double tower = as_double("tower_fixed_cost") *
                           exp(as_double("tower_exp") * (THT + 0.5 * (-H_rec + as_double("helio_height"))));
            ...
            //land area
            double land_area = spi.layout.land_area * as_double("csp.pt.sf.land_overhead_factor") +
            ...
            double cost_sales_tax =
                    as_double("sales_tax_rate") / 100. * total_direct_cost * as_double("sales_tax_frac") / 100.;
...
// for user specified x,y field
        ...
        if (as_integer("receiver_type") == 0) {
            ...
            set_unit_value_ssc_double(type222_receiver, "night_recirc",
                                      0.0);        // 8.15.15 twn: this is hardcoded for now - need to check that it is functioning correctly and reporting correct parasitics
            ...
            bConnected &= connect(type222_receiver, "q_startup", type251_controller,
            ...
            // cavity receiver
            throw exec_error("tcs_moltensalt", util::format(
                    "Connections and value settings haven't been programmed for this module yet! (MJW 2104.11.21"));
            ...
            set_unit_value_ssc_matrix(type232_cav_rec,
                                      "eps_wavelength"); //  [[4, e_solar, e_solar_p], [100,e_thermal,e_thermal_p]]);
            ...
            set_unit_value_ssc_double(type232_cav_rec, "deg_wind",
                                      0.0); // 8.7.15 twn: Don't need an SSC INPUT for a TCS *INPUT* as it is provided by another TCS type OUTPUT
...
//		set_unit_value_ssc_matrix(type251_controller, "field_fl_props", "store_fl_props");
        ...
        set_unit_value_ssc_double(type251_controller, "is_hx",
                                  0.0);    // 8.7.15 twn: MSPT assumes direct storage, no user input required here
        set_unit_value_ssc_double(type251_controller, "dt_hot",
                                  0.0);    // 8.7.15 twn: MSPT assumes direct storage, so can hardcode hot and cold approach temps = 0 and remove from SSC INPUTs
        set_unit_value_ssc_double(type251_controller, "dt_cold", 0.0);
        set_unit_value_ssc_double(type251_controller, "hx_config",
                                  0.0);    // 8.7.15 twn: similarly, there is no HX, so no user input required
        ...
        if (!is_steam_pc) {
            if (cycle_cutoff_fraction < 0.5) {
                char tstr[300];
                sprintf(tstr,
                        "The cycle cutoff fraction, %lg, was reset to 0.5 to improve the sCO2 model off-design convergence\n",
        ...
        set_unit_value_ssc_double(type251_controller, "tes_pump_coef",
                                  0.0); // 8.5.15 twn: MSPT does not have TES pumping losses as it assumes direct storage
        set_unit_value_ssc_double(type251_controller, "pb_fixed_par",
                                  0.0); //  8.7.15 twn: MSPT calculates fixed parasitic losses in type 228, not type 251
        ...
        set_unit_value_ssc_array(type251_controller,
                                 "tslogic_c"); //, [1,1,1,1,1,1,1,1,1]);	//Not sure if TOU schedule is synced, so make all variables independent of it
        ...
        if (is_steam_pc) {
            ...
            bConnected &= connect(type224_powerblock, "m_dot_demand", type251_controller,
            ...
            bConnected &= connect(type424_sco2, "m_dot_demand", type251_controller,
                                  "m_pb_demand");    //This is input is not used by the controller
        }
        ...
        if (is_steam_pc) {
            ...
            set_unit_value_ssc_double(type224_powerblock, "tech_type",
                                      1.0);    // 8.7.15 twn: compute module is for MSPT, so hardcode tech type and remove user input
        ...
        set_unit_value_ssc_double(type228_parasitics, "P_hot_tank",
                                  0.0);    // "tank_fp_par" from controller contains both hot and cold tank htr values
        ...
        if (0 > simulate(3600, hours * 3600, 3600))
            throw exec_error("tcsmolten_salt",
                             util::format("there was a problem simulating in the TCS molten salt model."));

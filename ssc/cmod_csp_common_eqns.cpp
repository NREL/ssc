...
HTFProperties
GetHtfProperties(int fluid_number, const util::matrix_t<double> &specified_fluid_properties) {       // [-]
    ...
    if (fluid_number != HTFProperties::User_defined) {
        ...
        if (n_rows > 2 && n_cols == 7) {
            ...
            std::string error_msg = util::format(
                    "The user defined fluid properties table must contain at least 3 rows and exactly 7 columns. The current table contains %d row(s) and %d column(s)",
                    n_rows, n_cols);
            throw (error_msg);
        }
    } else {
...
double
Csp_pt_sf_heliostat_area(double helio_height /*m*/, double helio_width /*m*/, double dens_mirror /*-*/) {     // [m2]
...
double
A_sf_UI(double helio_width /*m*/, double helio_height /*m*/, double dens_mirror /*-*/, int n_hel /*-*/) {  // [m2]
...
double C_atm_info(const util::matrix_t<ssc_number_t> &helio_positions /*m*/,
                  double c_atm_0 /*-*/, double c_atm_1 /*-*/, double c_atm_2 /*-*/, double c_atm_3 /*-*/,
                  double h_tower /*m*/) {  // [%]
...
double Csp_pt_rec_max_flow_to_rec(double csp_pt_rec_max_oper_frac /*-*/, double Q_rec_des /*MWt*/,
                                  double csp_pt_rec_htf_c_avg /*kJ/kg-K*/, double T_htf_hot_des /*C*/,
...
double
Piping_length(double h_tower /*m*/, double piping_length_mult /*-*/, double piping_length_const /*m*/) {      // [m]
...
double Csp_pt_cost_receiver_area(TowerTypes tower_type /*-*/, double d_rec /*m*/, double rec_height /*m*/,
                                 int receiver_type /*-*/, double rec_d_spec /*m*/,
...
double
Csp_pt_cost_power_block_mwe(TowerTypes tower_type /*-*/, double p_ref /*MWe*/, double demand_var /*MWe*/)       // [MWe]
{
...
void Tower_SolarPilot_Capital_Costs_Equations(ssc_data_t data) {
    ...
    vt_get_number(vt, "csp_pt_cost_receiver_area",
    ...
    vt_get_number(vt, "csp_pt_cost_storage_mwht",
    ...
    vt_get_number(vt, "csp_pt_cost_power_block_mwe",
    ...
    try {
        ...
        throw std::runtime_error(
                "MSPT system costs. System cost calculations failed. Check that all inputs are properly defined");
    }

...
/* Dispatch */                                                                    															       
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch1",	              "Energy produced by the system in TOD period 1",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch2",	                  "Energy produced by the system in TOD period 2",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch3",	                  "Energy produced by the system in TOD period 3",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch4",	                  "Energy produced by the system in TOD period 4",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch5",	                  "Energy produced by the system in TOD period 5",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch6",	                  "Energy produced by the system in TOD period 6",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch7",	                  "Energy produced by the system in TOD period 7",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch8",	                  "Energy produced by the system in TOD period 8",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_dispatch9",	                  "Energy produced by the system in TOD period 9",	               "",   "",  "Cash Flow Revenue",             "*",						   "LENGTH_EQUAL=cf_length",                 "" },
	...
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch1",             "First year energy from the system in TOD period 1",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch2",             "First year energy from the system in TOD period 2",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch3",             "First year energy from the system in TOD period 3",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch4",             "First year energy from the system in TOD period 4",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch5",             "First year energy from the system in TOD period 5",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch6",             "First year energy from the system in TOD period 6",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch7",             "First year energy from the system in TOD period 7",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch8",             "First year energy from the system in TOD period 8",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_dispatch9",             "First year energy from the system in TOD period 9",             "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
                                                                                  
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price1",                "First year energy price for TOD period 1",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price2",                "First year energy price for TOD period 2",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price3",                "First year energy price for TOD period 3",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price4",                "First year energy price for TOD period 4",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price5",                "First year energy price for TOD period 5",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price6",                "First year energy price for TOD period 6",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price7",                "First year energy price for TOD period 7",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price8",                "First year energy price for TOD period 8",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
	{ SSC_OUTPUT,        SSC_NUMBER,    "firstyear_energy_price9",                "First year energy price for TOD period 9",                      "",             "",                      "Cash Flow Revenue",      "*",                       "",                                  "" },
...
//	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear",	      "First year energy from the system by month",	"",   "",          "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD1",   "First year energy from the system by month for TOD period 1",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD2",   "First year energy from the system by month for TOD period 2",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD3",   "First year energy from the system by month for TOD period 3",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD4",   "First year energy from the system by month for TOD period 4",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD5",   "First year energy from the system by month for TOD period 5",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD6",   "First year energy from the system by month for TOD period 6",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD7",   "First year energy from the system by month for TOD period 7",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD8",   "First year energy from the system by month for TOD period 8",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,     "cf_energy_net_monthly_firstyear_TOD9",   "First year energy from the system by month for TOD period 9",   "",   "",                      "Cash Flow Revenue",             "*",				   "",                 "" },
...
/* DHF Capital Cost */                                                            
	...
	{ SSC_INPUT,        SSC_NUMBER,     "months_working_reserve",		          "Working capital reserve months of O&M",                          "months",            "",       "Other Capital Costs",        "?=6",              "INTEGER,MIN=0",      "" },
...
/* Partial Income Statement: Project */	
	...
	{ SSC_OUTPUT,       SSC_ARRAY,      "cf_reserve_total",                       "Total reserves",       "$",            "",                      "Cash Flow Reserves",      "*",                     "LENGTH_EQUAL=cf_length",                "" },
	...
	{ SSC_OUTPUT,       SSC_ARRAY,      "cf_funding_om",                          "O&M funding",       "$",            "",                      "Cash Flow Reserves",      "*",                     "LENGTH_EQUAL=cf_length",                "" },
	...
	{ SSC_OUTPUT,       SSC_ARRAY,      "cf_disbursement_om",                     "O&M disbursement",       "$",            "",                      "Cash Flow Reserves",      "*",                     "LENGTH_EQUAL=cf_length",                "" },
	...
	{ SSC_OUTPUT,       SSC_ARRAY,      "cf_project_me2ra",                       "Major equipment reserve account 2 (increase)/decrease",  "$", "",                      "Cash Flow Pre Tax",      "*",                     "LENGTH_EQUAL=cf_length",                "" },
	{ SSC_OUTPUT,       SSC_ARRAY,      "cf_project_me3ra",                       "Major equipment reserve account 3 (increase)/decrease",  "$", "",                      "Cash Flow Pre Tax",      "*",                     "LENGTH_EQUAL=cf_length",                "" },
	{ SSC_OUTPUT,       SSC_ARRAY,      "cf_project_ra",                          "Total reserve account (increase)/decrease",  "$", "",                      "Cash Flow Pre Tax",      "*",                     "LENGTH_EQUAL=cf_length",                "" },

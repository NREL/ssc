...
HTFProperties
GetHtfProperties(int fluid_number, const util::matrix_t<double> &specified_fluid_properties = NULL);       // [-]
...
double
Csp_pt_cost_storage_mwht(TowerTypes tower_type /*-*/, double p_ref = std::numeric_limits<double>::quiet_NaN() /*MWe*/,
...
double Csp_pt_cost_power_block_mwe(TowerTypes tower_type /*-*/,
                                   double p_ref = std::numeric_limits<double>::quiet_NaN() /*MWe*/,

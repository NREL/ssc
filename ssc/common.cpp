...
var_info vtab_technology_outputs[] = {
	/*   VARTYPE           DATATYPE         NAME                               LABEL                                       UNITS     META                                     GROUP                 REQUIRED_IF                 CONSTRAINTS                      UI_HINTS*/
		{ SSC_OUTPUT, SSC_ARRAY, "gen", "Power generated by renewable resource", "kW", "", "Time Series", "*", "", "" },
		{ SSC_OUTPUT, SSC_ARRAY, "hourly_gen", "Energy generated by renewable resource", "kWh", "", "Time Series", "*", "", "" },
		// optional - for utility rate calculations
		{ SSC_OUTPUT, SSC_ARRAY, "grid", "Power generated by system", "kW", "", "Time Series", "", "", "" },

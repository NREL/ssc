...
//    VARTYPE           DATATYPE          NAME                 LABEL                                                                                 UNITS            META            GROUP            REQUIRED_IF                 CONSTRAINTS             UI_HINTS
	...
	{ SSC_INPUT,	SSC_NUMBER, "nMod", "Number of collector modules in a loop", "", "", "controller", "*", "", "" },
	{ SSC_INPUT,	SSC_NUMBER, "nRecVar", "Number of receiver variantions", "", "", "controller", "?=4", "", "" },
	...
	{ SSC_INPUT, SSC_NUMBER, "Fluid", "Field HTF fluid number", "", "", "controller", "*", "", "" },
	...
	{ SSC_INPUT, SSC_NUMBER, "fthrctrl", "Defocusing strategy", "", "", "controller", "*", "", "" },
	...
	{ SSC_INPUT, SSC_NUMBER, "opt_model", "The optical model (1=Solar position ; 2=Collector incidence table ; 3 = IAM polys)", "", "", "controller", "*", "", "" },

...
//    VARTYPE           DATATYPE          NAME                 LABEL                                                                                 UNITS            META            GROUP            REQUIRED_IF                 CONSTRAINTS             UI_HINTS
	...
	{ SSC_INPUT, 	SSC_NUMBER,	"nMod", 			"Number of collector modules in a loop", 	"", 	"", 	"", 	"?=16" },
	{ SSC_INPUT, 	SSC_NUMBER,	"nRecVar", 			"Number of receiver variantions", 	"", 	"", 	"", 	"?=4" },
	{ SSC_INPUT, 	SSC_NUMBER,	"nLoops", 			"Number of loops in the field", 	"", 	"", 	"", 	"105" },
	{ SSC_INPUT, 	SSC_NUMBER,	"eta_pump", 		"HTF pump efficiency", 	"", 	"", 	"", 	"0.85" },
	...
	{ SSC_INPUT, 	SSC_NUMBER,	"FieldConfig", 		"Number of subfield headers", 	"", 	"", 	"", 	"2" },
	...
	{ SSC_INPUT, 	SSC_NUMBER,	"Fluid", 			"Field HTF fluid number", 	"", 	"", 	"", 	"17" },
	{ SSC_INPUT, 	SSC_NUMBER,	"T_field_ini", 		"Initial field temperature", 	"C", 	"", 	"", 	"300" },
	{ SSC_INPUT, 	SSC_MATRIX,	"HTF_data", 		"Fluid property data", 	"", 	"7 columns (T,Cp,dens,visc,kvisc,cond,h), 	at least 3 rows", 	"", 	"" },
	...
	{ SSC_INPUT, 	SSC_NUMBER,	"fthrok", 			"Flag to allow partial defocusing of the collectors", 	"", 	"", 	"", 	"1" },
	{ SSC_INPUT, 	SSC_NUMBER,	"fthrctrl", 		"Defocusing strategy", 	"", 	"", 	"", 	"2" },
	{ SSC_INPUT, 	SSC_NUMBER,	"ColAz", 			"Collector azimuth angle", 	"deg", 	"", 	"", 	"0" },
	{ SSC_INPUT, 	SSC_NUMBER,	"solar_mult", 		"Solar multiple", 	"", 	"", 	"", 	"2" },
	...
	{ SSC_INPUT, 	SSC_NUMBER,	"opt_model", 		"The optical model (1=Solar position ; 2=Collector incidence table ; 3 = IAM polys)", 	"", 	"", 	"", 	"1" },
	{ SSC_INPUT, 	SSC_NUMBER,	"A_aperture", 		"Reflective aperture area of the collector", 	"m2", 	"", 	"", 	"470.3" },
	{ SSC_INPUT, 	SSC_NUMBER,	"reflectivity", 	"Solar-weighted mirror reflectivity value ", 	"", 	"", 	"", 	"0.935" },
	{ SSC_INPUT, 	SSC_NUMBER, "TrackingError", 	"Tracking error derate", 	"", 	"", 	"", 	"0.994" },
	{ SSC_INPUT, 	SSC_NUMBER,	"GeomEffects", 		"Geometry effects derate", 	"", 	"", 	"", 	"0.98" },
	{ SSC_INPUT, 	SSC_NUMBER,	"Dirt_mirror", 		"User-defined dirt on mirror derate", 	"", 	"", 	"", 	"0.95" },
	{ SSC_INPUT, 	SSC_NUMBER,	"Error", 			"User-defined general optical error derate ", 	"", 	"", 	"", 	"0.99" },
	{ SSC_INPUT, 	SSC_NUMBER,	"L_mod", 			"The length of the collector module", 	"m", 	"", 	"", 	"44.8" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"IAM_T_coefs", 		"Incidence angle modifier coefficients - transversal plane", 	"", 	"", 	"", 	"0.9896,0.044,-0.0721,-0.2327,0." },
	{ SSC_INPUT, 	SSC_ARRAY, 	"IAM_L_coefs", 		"Incidence angle modifier coefficients - longitudinal plane", 	"", 	"", 	"", 	"1.0031,-0.2259,0.5368,-1.6434,0.7222" },
	{ SSC_INPUT, 	SSC_MATRIX,	"OpticalTable", 	"Values of the optical efficiency table", 	"", 	"", 	"", 	"" },

	{ SSC_INPUT, 	SSC_NUMBER,	"rec_model", 		"Receiver model type (1=Polynomial ; 2=Evac tube)", 	"", 	"", 	"", 	"2" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"HCE_FieldFrac", 	"The fraction of the field occupied by this HCE type ", 	"", 	"", 	"", 	"0.985,0.01,0.005,0" },
	...
	{ SSC_INPUT, 	SSC_ARRAY, 	"Flow_type", 		"The flow type through the absorber", 	"", 	"", 	"", 	"1,1,1,1" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"Rough", 			"Roughness of the internal surface ", 	"m", 	"", 	"", 	"4.50E-05,4.50E-05,4.50E-05,4.50E-05" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"alpha_env", 		"Envelope absorptance ", 	"", 	"", 	"", 	"0.02,0.02,0,0" },
	{ SSC_INPUT, 	SSC_MATRIX, "epsilon_abs_1", 	"Absorber emittance - HCE variation 1", 	"", 	"", 	"", 	"[100,150,200,250,300,350,400,450,500][0.064,0.0665,0.07,0.0745,0.08,0.0865,0.094,0.1025,0.112]" },
	{ SSC_INPUT, 	SSC_MATRIX, "epsilon_abs_2", 	"Absorber emittance - HCE variation 2", 	"", 	"", 	"", 	"0,.65" },
	{ SSC_INPUT, 	SSC_MATRIX, "epsilon_abs_3", 	"Absorber emittance - HCE variation 3", 	"", 	"", 	"", 	"0,.65" },
	{ SSC_INPUT, 	SSC_MATRIX, "epsilon_abs_4", 	"Absorber emittance - HCE variation 4", 	"", 	"", 	"", 	"0,0" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"alpha_abs", 		"Absorber absorptance ", 	"", 	"", 	"", 	"0.96,0.96,0.8,0" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"Tau_envelope", 	"Envelope transmittance", 	"", 	"", 	"", 	"0.963,0.963,1,0" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"epsilon_glass", 	"Glass envelope emissivity", 	"", 	"", 	"", 	"0.86,0.86,1,0" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"GlazingIntactIn", 	"The glazing intact flag {1=true, 	else=false}", 	"", 	"", 	"", 	"1,1,0,1" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"P_a", 				"Annulus gas pressure", 	"torr", 	"", 	"", 	"0.0001,750,750,0" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"AnnulusGas", 		"Annulus gas type (1=air, 	26=Ar, 	27=H2)", 	"", 	"", 	"", 	"27,1,1,27" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"AbsorberMaterial", "Absorber material type", 	"", 	"", 	"", 	"1,1,1,1" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"Shadowing", 		"Receiver bellows shadowing loss factor", 	"", 	"", 	"", 	"0.96,0.96,0.96,0.963" },
	{ SSC_INPUT, 	SSC_ARRAY, 	"dirt_env", 		"Loss due to dirt on the receiver envelope", 	"", 	"", 	"", 	"0.98,0.98,1,0.98" },
	...
	{ SSC_INPUT, 	SSC_ARRAY, 	"DP_coefs", 		"Pressure drop mass flow based part-load curve", 	"", 	"", 	"", 	"0.,1.,0.,0." },

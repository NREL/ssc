...
static var_info _cm_vtab_tcs_iscc[] = {
...
class cm_tcs_iscc : public tcKernel
{
public:

	cm_tcs_iscc(tcstypeprovider *prov)
	:tcKernel(prov)
	{
		add_var_info( _cm_vtab_tcs_iscc );
...
DEFINE_TCS_MODULE_ENTRY( tcs_iscc, "Triple pressure NGCC integrated with MS power tower", 4 )

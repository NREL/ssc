...
public:
    ...
    void exec() override {
        ...
        rc_des_par.m_T_mc_in =
                as_double("I_T_mc_in_des") + 273.15;            //[K] Compressor inlet temp at design, convert from C
        rc_des_par.m_T_t_in =
                as_double("I_T_t_in_des") + 273.15;            //[K] Turbine inlet temp at design, convert from C
        ...
        rc_des_par.m_N_t = as_double(
                "I_N_t_des");            //[rpm] Turbine speed, Negative number links to compressor speed

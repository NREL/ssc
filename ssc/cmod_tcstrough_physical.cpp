...
//   VARTYPE            DATATYPE          NAME                        LABEL                                                                               UNITS           META            GROUP             REQUIRED_IF                CONSTRAINTS              UI_HINTS
    ...
    { SSC_INPUT,        SSC_NUMBER,      "nColt",                     "Number of collector types",                                                        "none",         "",             "solar_field",    "*",                       "",                      "" },
  ...
  //{ SSC_INPUT,        SSC_NUMBER,      "ColTilt",                   "Collector tilt angle (0 is horizontal, 90deg is vertical)",                        "deg",         "",             "solar_field",    "*",                       "",                      "" },
  //{ SSC_INPUT,        SSC_NUMBER,      "ColAz",                     "Collector azimuth angle",                                                          "deg",          "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_NUMBER,      "accept_mode",               "Acceptance testing mode? (1=yes, 0=no)",                                           "none",          "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_NUMBER,      "accept_init",               "In acceptance testing mode - require steady-state startup",                        "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_NUMBER,      "accept_loc",                "In acceptance testing mode - temperature sensor location (1=hx,2=loop)",           "none",         "",             "solar_field",    "*",                       "",                      "" },
    ...
    { SSC_INPUT,        SSC_ARRAY,       "OptCharType",               "Optical characterization method ",                                                 "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_ARRAY,       "CollectorType",             "Collector type (1=user defined, 2=LS-2, 3=LS-3, 4=IST) ",                          "none",         "",             "solar_field",    "*",                       "",                      "" },
    ...
    { SSC_INPUT,        SSC_ARRAY,       "reflectivity",              "Base solar-weighted mirror reflectivity value ",                                   "none",         "",             "solar_field",    "*",                       "",                      "" },
    ...
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_11",              "Absorber emittance - HCE type 1 - HCE variation 1",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_12",              "Absorber emittance - HCE type 1 - HCE variation 2",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_13",              "Absorber emittance - HCE type 1 - HCE variation 3",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_14",              "Absorber emittance - HCE type 1 - HCE variation 4",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_21",              "Absorber emittance - HCE type 2 - HCE variation 1",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_22",              "Absorber emittance - HCE type 2 - HCE variation 2",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_23",              "Absorber emittance - HCE type 2 - HCE variation 3",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_24",              "Absorber emittance - HCE type 2 - HCE variation 4",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_31",              "Absorber emittance - HCE type 3 - HCE variation 1",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_32",              "Absorber emittance - HCE type 3 - HCE variation 2",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_33",              "Absorber emittance - HCE type 3 - HCE variation 3",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_34",              "Absorber emittance - HCE type 3 - HCE variation 4",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_41",              "Absorber emittance - HCE type 4 - HCE variation 1",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_42",              "Absorber emittance - HCE type 4 - HCE variation 2",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_43",              "Absorber emittance - HCE type 4 - HCE variation 3",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_MATRIX,      "epsilon_3_44",              "Absorber emittance - HCE type 4 - HCE variation 4",                                "none",         "",             "solar_field",    "*",                       "",                      "" },
    ...
    { SSC_INPUT,        SSC_MATRIX,      "SCAInfoArray",              "(:,1) = HCE type, (:,2)= Collector type for each SCA in the loop ",                "none",         "",             "solar_field",    "*",                       "",                      "" },
    { SSC_INPUT,        SSC_ARRAY,       "SCADefocusArray",           "Order in which the SCA's should be defocused",                                     "none",         "",             "solar_field",    "*",                       "",                      "" },

...
//   weather file reader
//   VARTYPE            DATATYPE          NAME                LABEL                                                             UNITS           META            GROUP            REQUIRED_IF                CONSTRAINTS              UI_HINTS
    { SSC_OUTPUT,       SSC_ARRAY,       "beam",              "Resource DNI",                                         "W/m2",         "",            "weather",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "hour",              "Resource hour of day",                                                    "",             "",            "weather",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "pres",              "Resource atmospheric pressure",                                                       "mbar",         "",            "weather",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "wspd",              "Resource wind speed",                                                     "m/s",          "",            "weather",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "solazi",            "Resource solar azimuth angle",                                                  "deg",          "",            "weather",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "solzen",            "Resource solar zenith angle",                                                   "deg",          "",            "weather",        "*",                       "LENGTH=8760",           "" },
    ...
    { SSC_OUTPUT,       SSC_ARRAY,       "EqOpteff",          "Field collector equivalent optical efficiency",                        "none",         "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    ...
    { SSC_OUTPUT,       SSC_ARRAY,       "dni_costh",         "Field cosine effect product of DNI",                                      "W/m2",         "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "qinc_costh",        "Field cosine effect product of incident irradiance",                          "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "P_cond",            "Power cycle condenser pressure",                                             "Pa",           "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "f_bays",            "Power cycle fraction of operating heat rejection bays",                      "none",         "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "m_dot_avail",       "Mass flow rate of HTF from field",                              "kg/hr",        "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "m_dot_pb",          "Mass flow rate of HTF to power cycle",                                    "kg/hr",        "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    ...
    { SSC_OUTPUT,       SSC_ARRAY,       "m_dot_aux",         "Mass flow rate from auxiliary heater",                                "kg/hr",        "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "m_dot_htf2",        "Mass flow rate in a single loop",                                     "kg/s",         "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "m_dot_makeup",      "Mass flow rate of makeup cooling water",                                 "kg/hr",        "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "SCAs_def",          "Field fraction of focused SCA's",                                      "none",         "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "mass_tank_cold",    "TES mass of fluid in cold tank",                           "kg",           "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "mass_tank_hot",     "TES mass of fluid in hot tank",                            "kg",           "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "DP_tot",            "Field HTF total pressure drop",                                        "bar",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "eta",               "Power cycle thermal efficiency",                                       "none",         "",            "Type224",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "W_dot_pump",        "Field required pumping power",                             "MWh",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "htf_pump_power",    "TES and power cycle loop pumping power",                   "MWh",          "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "SCA_par_tot",       "Parasitic power consumed by the SC drives",             "MWh",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "bop_par",           "Parasitic power as a function of power block load",              "MWh",          "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "fixed_par",         "Parasitic power fixed",         "MWh",          "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "aux_par",           "Parasitic power for auxiliary heater",               "MWh",          "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "W_cool_par",        "Parasitic power for cooling system",                                  "MWh",          "",            "Type224",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "W_cycle_gross",     "Power cycle gross output",                                       "MWe",          "",            "Net_E_Calc",     "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "W_net",             "Power cycle net output",                                         "MWe",          "",            "Net_E_Calc",     "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "q_avail",           "Thermal energy available from field",                            "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "q_inc_sf_tot",      "Field incident irradiance",                              "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "q_abs_tot",         "Field total absorbed energy",                                          "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "q_pb",              "Thermal energy to the power block",                              "MWt",          "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "q_to_tes",          "Thermal energy to storage",                                    "MWt",          "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "Pipe_hl",           "Field pipe heat loss in hot header and runner",            "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "q_dump",            "Thermal energy dumped",                                          "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "tank_losses",       "Thermal losses from tank",                                       "MWt",          "",            "Type251",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "q_loss_tot",        "Field receiver thermal and optical losses",                      "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "q_loss_spec_tot",   "Field receiver average thermal losses",                          "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "Q_aux_backup",      "Thermal energy from auxiliary fossil backup",       "MWt",          "",            "SumCalc",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "Fuel_usage",        "Fossil fuel usage by all plant subsystems",                "MMBTU",        "",            "SumCalc",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "Q_par_sf_fp",       "Field freeze protection energy",   "MWt",          "",            "SumCalc",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "Q_par_tes_fp",      "TES freeze protection energy",               "MWt",          "",            "SumCalc",        "*",                       "LENGTH=8760",           "" },
    { SSC_OUTPUT,       SSC_ARRAY,       "E_bal_startup",     "Startup energy consumed",                                        "MWt",          "",            "Type250",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_field_in",        "Field HTF temperature into collector field header",                    "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_sys_h",           "Field HTF outlet temperature",                             "C",            "",            "Type250",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_sys_c",           "Field collector inlet temperature",                                    "C",            "",            "Type250",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_tank_cold_in",    "TES cold tank HTF inlet temperature",                                "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_tank_hot_in",     "TES hot tank HTF inlet temperature",                                 "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_tank_cold_fin",   "TES cold tank HTF temperature at end of timestep",                   "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_tank_hot_fin",    "TES hot tank HTF temperature at end of timestep",                    "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "Ts_hot",            "TES hot HTF exiting storage HX",                                     "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "Ts_cold",           "TES cold HTF exiting storage HX",                                    "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_pb_in",           "Power cycle HTF temperature to power cycle",                                 "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "T_pb_out",          "Power cycle HTF temperature from power cycle",                         "C",            "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "vol_tank_cold_fin", "TES cold tank HTF volume at end of timestep",                        "m3",           "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "vol_tank_hot_fin",  "TES hot tank HTF volume at end of timestep",                         "m3",           "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "vol_tank_total",    "TES total HTF volume in storage",                                    "m3",           "",            "Type251",        "*",                       "LENGTH=8760",           "" },
	
	// Monthly Outputs
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_energy",        "Monthly energy",                                             "kWh",           "",            "Net_E_Calc",     "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_W_cycle_gross", "Power cycle gross output",                                   "MWhe",          "",            "Net_E_Calc",     "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_q_inc_sf_tot",  "Field total incident irradiance",                          "MWht",          "",            "Type250",        "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_q_abs_tot",     "Field total absorbed energy",                                      "MWht",          "",            "Type250",        "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_q_avail",       "Thermal energy available from field",                        "MWht",          "",            "Type250",        "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_Fuel_usage",    "Fossil fuel used by all plant subsystems",            "MMBTU",        "",            "SumCalc",        "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_q_dump",        "Thermal energy dumped",                                      "MWht",          "",            "Type250",        "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_m_dot_makeup",  "Mass flow rate of makeup cooling water",                             "kg/hr",        "",            "Type250",        "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_q_pb",          "Thermal energy to the power block",                          "MWht",          "",            "Type251",        "*",                       "LENGTH=12",             "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "monthly_q_to_tes",      "Thermal energy to storage",                                "MWht",          "",            "Type251",        "*",                       "LENGTH=12",             "" },

	// Annual Outputs
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_energy",         "Annual energy",                                              "kWh",           "",            "Net_E_Calc",     "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_W_cycle_gross",  "Power cycle gross output",                                   "MWhe",          "",            "Net_E_Calc",     "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_q_inc_sf_tot",   "Field total incident irradiance",                          "MWht",          "",            "Type250",        "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_q_abs_tot",      "Field total absorbed energy",                                      "MWht",          "",            "Type250",        "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_q_avail",        "Thermal power available from field",                        "MWht",          "",            "Type250",        "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_q_aux",          "Fossil fuel used by all plant subsystems",            "MMBTU",        "",            "SumCalc",        "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_q_dump",         "Thermal energy dumped",                                      "MWht",          "",            "Type250",        "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_m_dot_makeup",   "Mass flow rate of makeup cooling water",                             "kg/hr",        "",            "Type250",        "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_q_pb",           "Thermal energy to the power block",                          "MWht",          "",            "Type251",        "*",                       "",                      "" },
	{ SSC_OUTPUT,       SSC_NUMBER,      "annual_q_to_tes",       "Thermal energy to storage",                                "MWht",          "",            "Type251",        "*",                       "",                      "" },

	// Other single value outputs
	{ SSC_OUTPUT,       SSC_NUMBER,      "conversion_factor",     "Gross-to-net conversion",                             "%",            "",            "Calculated",     "*",                       "",                      "" },

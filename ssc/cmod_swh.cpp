...
//	{ SSC_OUTPUT,       SSC_ARRAY,       "Q_saved",               "Q saved",                          "kWh",    "",                      "SWH",      "*",                        "LENGTH=8760",                      "" },
	{ SSC_OUTPUT,       SSC_ARRAY,       "system_hourly_energy",  "System energy",                          "kWh",    "",                      "SWH",      "*",                        "LENGTH=8760",                      "" },
...
//		ssc_number_t *out_Q_saved = allocate("Q_saved", 8760);
		ssc_number_t *out_system_hourly_energy = allocate("system_hourly_energy", 8760);
...
//			out_Q_saved[i] = (ssc_number_t) (Q_saved* W2kW);
			out_system_hourly_energy[i] =(ssc_number_t) (Q_saved* W2kW);

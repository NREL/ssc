...
//	{ SSC_INPUT,        SSC_NUMBER,      "module_rad4",                     "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",                          "none",        "",        "hcpv",          "*",                    "",                              "" },
  ...
  //{ SSC_INPUT,        SSC_ARRAY,       "array_azalt_sf",                  "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",                          "xxx",    "",        "hcpv",          "*",                    "",                              "" },
	...
	// outputs
	//VARTYPE           DATATYPE         NAME                               LABEL                                                              UNITS     META       GROUP            REQUIRED_IF             CONSTRAINTS                      UI_HINTS
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_solazi",                   "Hourly solar azimuth",                                            "deg",    "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_solzen",                   "Hourly solar zenith",                                             "deg",    "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_sazi",                     "Tracker azimuth",                                                 "deg",    "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_stilt",                    "Tracker tilt",                                                    "deg",    "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_sunup",                    "Sun up? (0/1)",                                                   "0 or 1", "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	...
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_airmass",                  "Relative air mass",                                               "none",   "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_shading_derate",           "Shading derate",                                                  "none",   "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_poa",                      "POA on cell",                                                     "W/m2",   "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_input_radiation",          "Input radiation",                                                 "kWh",    "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_tmod",                     "Module backplate temp",                                           "C",      "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_tcell",                    "Cell temperature",                                                "C",      "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_celleff",                  "Cell efficiency",                                                 "%",      "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },
	{ SSC_OUTPUT,        SSC_ARRAY,      "hourly_modeff",                   "Module efficiency",                                               "%",      "",        "hcpv",          "*",                    "LENGTH=8760",                              "" },

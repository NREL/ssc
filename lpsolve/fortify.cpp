...
#if defined MSDOS || defined __BORLANDC__ || defined LPWINAPP || defined __HIGHC__
# include <direct.h>
#endif
...
#if !defined MSDOS && !defined LPWINAPP
        	...
        	file=stderr;
                ...
                if ((ptr=getenv("FORTIFY_OUTPUT"))!=NULL)
                {
                        if ((stricmp(ptr,"null")==0) || (stricmp(ptr,"nul")==0))
                                ...
                                file=stdout;
#if defined MSDOS && !defined _WINDOWS && !defined LPWINAPP
